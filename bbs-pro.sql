/*
 ...
 Source Host           : 119.91.192.149:3306
...
CREATE TABLE `answer`  (
  ...
  `questionId` bigint(0) NULL DEFAULT NULL,
  ...
  INDEX `answer_1_idx`(`questionId`, `status`, `adoption`) USING BTREE,
  INDEX `answer_2_idx`(`userName`, `isStaff`) USING BTREE
...
CREATE TABLE `answerlike_0`  (
  ...
  `answerId` bigint(0) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `answerLike_1_idx`(`answerId`, `addtime`) USING BTREE
...
CREATE TABLE `answerreply`  (
  ...
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `lastUpdateTime` datetime(0) NULL DEFAULT NULL,
  `friendReplyId` bigint(0) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `answerReply_1_idx`(`answerId`, `status`) USING BTREE,
  INDEX `answerReply_2_idx`(`questionId`) USING BTREE,
  INDEX `answerReply_3_idx`(`userName`, `isStaff`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `answerreplylike_0`  (
  ...
  `postUserName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `questionId` bigint(0) NULL DEFAULT NULL,
  `replyId` bigint(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `likeId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `answerReply_1_idx`(`replyId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `answerreplylike_1`  (
  ...
  `likeId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `answerReplyLike_1_idx`(`replyId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `comment`  (
  ...
  `topicId` bigint(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `status` int(0) NULL DEFAULT NULL,
  `lastUpdateTime` datetime(0) NULL DEFAULT NULL,
  `isMarkdown` bit(1) NULL DEFAULT NULL,
  `markdownContent` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `comment_1_idx`(`topicId`, `status`) USING BTREE,
  INDEX `comment_2_idx`(`quoteIdGroup`(191)) USING BTREE,
  INDEX `comment_3_idx`(`userName`, `isStaff`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES (1, '11撒旦', '0:0:0:0:0:0:0:1', b'0', '2024-08-07 11:01:36', NULL, ',', ',', 1, 'S30haD6EltuuM6z7CD4', 120, NULL, b'0', NULL);
INSERT INTO `comment` VALUES (2, 'zhen\'de\'ma', '0:0:0:0:0:0:0:1', b'1', '2024-08-11 17:23:43', NULL, ',', ',', 4, 'admin', 100020, NULL, b'0', NULL);
INSERT INTO `comment` VALUES (3, '我bu\'xin', '0:0:0:0:0:0:0:1', b'1', '2024-08-11 17:23:53', NULL, ',', ',', 4, 'admin', 100020, NULL, b'0', NULL);
INSERT INTO `comment` VALUES (4, '你说的是真的？', '0:0:0:0:0:0:0:1', b'1', '2024-08-11 17:24:16', NULL, ',', ',', 4, 'admin', 20, NULL, b'0', NULL);
INSERT INTO `comment` VALUES (5, '哦哦哦', '0:0:0:0:0:0:0:1', b'0', '2024-08-11 17:25:40', NULL, ',', ',', 4, 'VUWuDd534ygxgEaaVJv', 120, NULL, b'0', NULL);
...
CREATE TABLE `commentlike_0`  (
  `id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `addtime` datetime(0) NULL DEFAULT NULL,
  `commentId` bigint(0) NULL DEFAULT NULL,
  `postUserName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `topicId` bigint(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `likeId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `commentLike_1_idx`(`commentId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `commentreplylike_0`  (
  ...
  `likeId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `commentReply_1_idx`(`replyId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `commentreplylike_1`  (
  ...
  `likeId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `commentReplyLike_1_idx`(`replyId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `customreply`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `customCommentId` bigint(0) NULL DEFAULT NULL,
  `customItemId` bigint(0) NULL DEFAULT NULL,
  `ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `staff` bit(1) NOT NULL,
  `times` datetime(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `customReply_1_idx`(`customCommentId`) USING BTREE,
  INDEX `customReply_2_idx`(`customItemId`) USING BTREE,
  INDEX `customReply_3_idx`(`userName`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `favorites_0`  (
  ...
  `topicId` bigint(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `module` int(0) NULL DEFAULT NULL,
  `questionId` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `favorites_1_idx`(`userName`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `feedback`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `feedback_1_idx`(`createDate`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `follow_0`  (
  ...
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `follow_1_idx`(`userName`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- Records of follow_2
-- ----------------------------
INSERT INTO `follow_2` VALUES ('3-2', '2024-08-11 17:23:08', 'gMLDMPa0UGxAbMQM9NM', 'VUWuDd534ygxgEaaVJv');
...
CREATE TABLE `follower_0`  (
  ...
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `follower_1_idx`(`userName`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `follower_3` VALUES ('2-3', '2024-08-11 17:23:08', 'VUWuDd534ygxgEaaVJv', 'gMLDMPa0UGxAbMQM9NM');
...
CREATE TABLE `forum`  (
  ...
  `invokeMethod` int(0) NULL DEFAULT NULL,
  ...
  `layoutType` int(0) NULL DEFAULT NULL,
  ...
  `queryMode` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `giveredenvelope`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `giveRedEnvelope_1_idx`(`bindTopicId`) USING BTREE,
  INDEX `giveRedEnvelope_2_idx`(`userId`, `giveTime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `help`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `helpTypeId` bigint(0) NULL DEFAULT NULL,
  ...
  `markdownContent` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `help_idx`(`helpTypeId`, `visible`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `helptype`  (
  ...
  `childNodeNumber` int(0) NULL DEFAULT NULL,
  `helpQuantity` bigint(0) NULL DEFAULT NULL,
  ...
  `totalHelp` bigint(0) NULL DEFAULT NULL,
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `image` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `helpType_1_idx`(`parentId`) USING BTREE,
  INDEX `helpType_2_idx`(`parentIdGroup`(191)) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `layout`  (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `dirName` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `forumData` int(0) NULL DEFAULT NULL,
  `layoutFile` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `referenceCode` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `returnData` int(0) NULL DEFAULT NULL,
  `sort` int(0) NULL DEFAULT NULL,
  `type` int(0) NULL DEFAULT NULL,
...
-- Records of layout
-- ----------------------------
INSERT INTO `layout` VALUES ('0133f7f7319441138e4a70248c33829b', 'default', -1, 'login.html', '登录页', 'login', 0, 160, 1, b'0');
INSERT INTO `layout` VALUES ('0146a94f857542fa8868706d43712cf0', 'api', -1, 'followerList.html', '粉丝列表', 'user/control/followerList', 0, 1300, 1, b'0');
INSERT INTO `layout` VALUES ('0237f9d88e6d42b88339832be56da0b2', 'api', -1, 'giveRedEnvelopeList.html', '发红包列表', 'user/control/giveRedEnvelopeList', 0, 2200, 1, b'0');
INSERT INTO `layout` VALUES ('02619989d8fe4ca6b60d0cd855cf57a9', 'default', -1, 'blank_15.html', '修改答案', 'user/editAnswer', 0, 2180, 4, b'0');
INSERT INTO `layout` VALUES ('030d51bc3c7a4f85a9a8b27f59b8dc91', 'api', -1, NULL, '查询帮助列表', 'queryHelpList', 1, 2840, 4, b'0');
INSERT INTO `layout` VALUES ('03961f034c7f406f9208f16d199512a2', 'default', -1, 'updatePhoneBinding_step1.html', '更换绑定手机第一步', 'user/control/updatePhoneBinding/step1', 0, 276, 1, b'0');
INSERT INTO `layout` VALUES ('03d87267e62e45348c5be7b6a7d12907', 'api', -1, 'paymentCompleted.html', '付款完成页面', 'paymentCompleted', 0, 1600, 1, b'0');
INSERT INTO `layout` VALUES ('0539cfc710694d57abbd55f40836d853', 'api', -1, 'payment.html', '付款页面', 'user/control/payment', 0, 1500, 1, b'0');
INSERT INTO `layout` VALUES ('05c03df92de74379bd46f800a9861625', 'api', -1, 'userDynamicList.html', '用户动态列表', 'user/control/userDynamicList', 0, 900, 1, b'0');
INSERT INTO `layout` VALUES ('0d062401879945608b9abdd30670db64', 'api', -1, 'replyList.html', '我的回复', 'user/control/replyList', 0, 180, 1, b'0');
INSERT INTO `layout` VALUES ('0de585bdbffa4862bcd3342c6361b928', 'api', -1, 'userLoginLogList.html', '用户登录日志列表', 'user/control/userLoginLogList', 0, 310, 1, b'0');
INSERT INTO `layout` VALUES ('0f61e4a78bba476faa52040b15c25597', 'default', -1, NULL, '修改话题(移动版)', 'queryEditTopic', 1, 1740, 4, b'0');
INSERT INTO `layout` VALUES ('0f667ec7b1884604a164a22c0fe037e0', 'default', -1, 'blank_7.html', '修改话题', 'user/editTopic', 0, 1730, 4, b'0');
INSERT INTO `layout` VALUES ('10494f8de46746e0886518832a168d9c', 'default', -1, 'balance.html', '余额', 'user/control/balance', 0, 1400, 1, b'0');
INSERT INTO `layout` VALUES ('139c10a2b22b43f38aa2b8680be5cf2c', 'api', -1, NULL, '栏目列表', 'columnList', 1, 2410, 4, b'0');
INSERT INTO `layout` VALUES ('13f0e445ce6d416fb33a63558ce70b4b', 'default', -1, NULL, '查询帮助内容(移动端)', 'queryHelpContent', 1, 2460, 4, b'0');
INSERT INTO `layout` VALUES ('1768830e9027429ba66d7ac824128fd7', 'api', -1, 'findPassWord_step1.html', '找回密码第一步', 'findPassWord/step1', 0, 136, 1, b'0');
INSERT INTO `layout` VALUES ('197fb4524ba0483d8406ee25fdc21487', 'default', -1, 'blank_8.html', '问题列表', 'askList', 0, 1750, 4, b'0');
INSERT INTO `layout` VALUES ('1a03c7d8ad84478ea63187f1fbd8ebc7', 'api', -1, 'register.html', '注册页', 'register', 0, 130, 1, b'0');
INSERT INTO `layout` VALUES ('1a22c5bcf0db4a229c3d3db8e1b96e53', 'api', -1, 'updatePhoneBinding_step2.html', '更换绑定手机第二步', 'user/control/updatePhoneBinding/step2', 0, 277, 1, b'0');
INSERT INTO `layout` VALUES ('1aae84f9973743078b7da1914d4117cf', 'api', -1, 'systemNotifyList.html', '系统通知列表', 'user/control/systemNotifyList', 0, 500, 1, b'0');
INSERT INTO `layout` VALUES ('1c3a08c1f26e49d2a31be02187010ef3', 'default', -1, NULL, '标签列表', 'quote_1', 0, 390, 6, b'0');
INSERT INTO `layout` VALUES ('1d95af33c5ff4eff96c56a79d3ec68dd', 'default', -1, NULL, '问题内容(移动版)', 'queryQuestionContent', 1, 2040, 4, b'0');
INSERT INTO `layout` VALUES ('1e409d85a5e744f19970258e8ca87f48', 'default', -1, 'agreement.html', '用户协议', 'agreement', 0, 135, 1, b'0');
INSERT INTO `layout` VALUES ('20a1d2ffa25c4f4299b94e905b098218', 'default', -1, 'newPublic_5.html', '单页应用模板(移动版)', 'newPublic_5', 0, 400, 5, b'0');
INSERT INTO `layout` VALUES ('20f3f5229e244aaa9640fa4458f2451e', 'default', -1, 'blank_14.html', '修改评论回复', 'user/editCommentReply', 0, 2140, 4, b'0');
INSERT INTO `layout` VALUES ('2286b0ba46bc4ca29d1528b9832d115b', 'api', -1, NULL, '查询用户是否已经收藏该问题', 'queryAlreadyFavoriteQuestion', 1, 2720, 4, b'0');
INSERT INTO `layout` VALUES ('24475e3169834022a2e9da4d55a30614', 'api', -1, 'balance.html', '余额', 'user/control/balance', 0, 1400, 1, b'0');
INSERT INTO `layout` VALUES ('264de55f35114b2f94e8048de00d7c29', 'default', -1, 'newPublic_4.html', '服务导航', 'newPublic_4', 0, 380, 5, b'0');
INSERT INTO `layout` VALUES ('27a1ac573f9546ddb811417129d6ab52', 'api', -1, NULL, '查询会员卡', 'queryMembershipCard', 1, 2810, 4, b'0');
INSERT INTO `layout` VALUES ('27ce9c5cba6b477882cddf32d3c4046e', 'api', -1, 'privateMessageList.html', '私信列表', 'user/control/privateMessageList', 0, 350, 1, b'0');
INSERT INTO `layout` VALUES ('29381b0502b24fb5838f52a96a7b9c7a', 'api', -1, 'home.html', '用户中心页', 'user/control/home', 0, 170, 1, b'0');
INSERT INTO `layout` VALUES ('2b91af2b82c24f568e8ce88708343023', 'default', -1, NULL, '添加举报(移动端)', 'user/queryAddReport', 1, 2490, 4, b'0');
INSERT INTO `layout` VALUES ('2bbbed906eac4491b0878573e8211406', 'default', -1, 'point.html', '积分', 'user/control/point', 0, 220, 1, b'0');
INSERT INTO `layout` VALUES ('2eb34391373643b59430301b390d87f8', 'api', -1, NULL, '查询所有问题标签', 'queryAllQuestionTag', 1, 2680, 4, b'0');
INSERT INTO `layout` VALUES ('2f0b565a37f24ed5a874ee587dda4394', 'default', -1, 'topicFavoriteList.html', '话题收藏列表', 'user/control/topicFavoriteList', 0, 700, 1, b'0');
INSERT INTO `layout` VALUES ('31f359bb910044749c8073b861fa2909', 'default', -1, NULL, '发表问题(移动版)', 'queryAddQuestion', 1, 2060, 4, b'0');
INSERT INTO `layout` VALUES ('32df80989f8d4b4ebc359364bef9a07d', 'default', -1, 'index.html', '首页', 'index', 0, 10, 1, b'0');
INSERT INTO `layout` VALUES ('339ad4fabe7c4362ace884fa0f56feea', 'default', -1, 'blank_17.html', '帮助中心', 'help', 0, 2430, 4, b'0');
INSERT INTO `layout` VALUES ('35c54a00b15148eb93ba8068fae4a8e1', 'default', -1, 'updatePhoneBinding_step2.html', '更换绑定手机第二步', 'user/control/updatePhoneBinding/step2', 0, 277, 1, b'0');
INSERT INTO `layout` VALUES ('3736da6867314018be676c56a28a582a', 'api', -1, 'index.html', '首页', 'index', 0, 10, 1, b'0');
INSERT INTO `layout` VALUES ('375cd75aaa974f779a3efd448b6ef483', 'default', -1, NULL, '评论列表(移动版)', 'queryCommentList', 1, 450, 4, b'0');
INSERT INTO `layout` VALUES ('3ada0d609b9b47388cdadfcbb1b02a6c', 'default', -1, 'userLoginLogList.html', '用户登录日志列表', 'user/control/userLoginLogList', 0, 310, 1, b'0');
INSERT INTO `layout` VALUES ('3e03f55f72804dde9a9874d94f15d7d5', 'api', -1, 'answerList.html', '我的答案', 'user/control/answerList', 0, 1900, 1, b'0');
INSERT INTO `layout` VALUES ('402eabef91f246859d854838997e6eb6', 'default', -1, NULL, '查询用户是否已经点赞该话题', 'queryAlreadyLiked', 1, 920, 4, b'0');
INSERT INTO `layout` VALUES ('417ea9d80bf3488aa312cc1bb8c6a3f9', 'api', -1, 'topicFavoriteList.html', '话题收藏列表', 'user/control/topicFavoriteList', 0, 700, 1, b'0');
INSERT INTO `layout` VALUES ('419e6748fc534966a67ad4e8443dc216', 'default', -1, NULL, '查询帮助列表(移动端)', 'queryHelpList', 1, 2470, 4, b'0');
INSERT INTO `layout` VALUES ('440b1b2f202d4de38f450226083ca174', 'default', -1, 'home.html', '用户中心页', 'user/control/home', 0, 170, 1, b'0');
INSERT INTO `layout` VALUES ('444c325c26504de9913e844f8648ce1e', 'default', -1, 'followerList.html', '粉丝列表', 'user/control/followerList', 0, 1300, 1, b'0');
INSERT INTO `layout` VALUES ('4605cd9bb304408883ecc648ba911e37', 'default', -1, NULL, '查询关注总数', 'queryFollowCount', 1, 2010, 4, b'0');
INSERT INTO `layout` VALUES ('46e93b23a0fe49eebaafe1c8c4705238', 'api', -1, NULL, '查询答案列表', 'queryAnswerList', 1, 2750, 4, b'0');
INSERT INTO `layout` VALUES ('4888f0f582df41c68c7bc98deba72711', 'api', -1, NULL, '查询修改评论表单', 'user/queryEditComment', 1, 2590, 4, b'0');
INSERT INTO `layout` VALUES ('4908dc43828d484d80cc1235b7f1c572', 'api', -1, 'topicLikeList.html', '话题点赞列表', 'user/control/topicLikeList', 0, 1100, 1, b'0');
INSERT INTO `layout` VALUES ('4a9681cc36d54a88be3ca330c28d1675', 'default', -1, NULL, '查询用户是否已收藏话题', 'queryAlreadyCollected', 1, 720, 4, b'0');
INSERT INTO `layout` VALUES ('4c0ff429df524417999b1bdcd2e34549', 'api', -1, NULL, '查询添加在线留言表单', 'queryAddFeedback', 1, 2860, 4, b'0');
INSERT INTO `layout` VALUES ('4dd50167d54b43f48089e1fc433baff7', 'api', 3, 'more_help.html', '在线帮助\'更多\'', 'more', 0, 60, 1, b'0');
INSERT INTO `layout` VALUES ('4ddaf163935e4e3cad6b3901cfb38d19', 'api', -1, NULL, '修改话题', 'user/editTopic', 1, 2560, 4, b'0');
INSERT INTO `layout` VALUES ('4ecf97fde2584bd9a5f495ac447dd091', 'default', -1, NULL, '服务条款(移动版)', 'termsService', 1, 410, 4, b'0');
INSERT INTO `layout` VALUES ('4f6397a608a548be8b09a6b06c788e50', 'default', -1, NULL, '修改答案(移动版)', 'queryEditAnswer', 1, 2200, 4, b'0');
INSERT INTO `layout` VALUES ('4f98b0ca689c4fb495c0a12cafe5a650', 'default', -1, NULL, '问题列表(移动版)', 'queryQuestionList', 1, 2030, 4, b'0');
INSERT INTO `layout` VALUES ('4f99621be57642109a3040138ad3afca', 'default', -1, NULL, '修改答案回复(移动版)', 'queryEditAnswerReply', 1, 2210, 4, b'0');
INSERT INTO `layout` VALUES ('50f0a08d6cf34fa699f549a95aa5bc47', 'default', -1, 'remindList.html', '提醒列表', 'user/control/remindList', 0, 550, 1, b'0');
INSERT INTO `layout` VALUES ('5174250d9377410085e2b66f9e6866f2', 'api', -1, 'search.html', '话题搜索页', 'search', 0, 30, 1, b'0');
INSERT INTO `layout` VALUES ('51c556e4c09a44f8bbf2721b2fde7c55', 'default', -1, NULL, '话题列表(移动版)', 'queryTopicList', 1, 420, 4, b'0');
INSERT INTO `layout` VALUES ('51ff5c4c03634e1f9776916ff28e3f64', 'api', -1, 'privateMessageChatList.html', '私信对话列表', 'user/control/privateMessageChatList', 0, 400, 1, b'0');
INSERT INTO `layout` VALUES ('52432df32db44bd9b37f97bfd68f5dfd', 'default', -1, 'blank_19.html', '添加举报', 'user/addReport', 0, 2500, 4, b'0');
INSERT INTO `layout` VALUES ('53349d99e80c4667883ffffdd9ff9e8e', 'default', -1, 'blank_12.html', '追加提问', 'user/appendQuestion', 0, 2090, 4, b'0');
INSERT INTO `layout` VALUES ('554557f4f99f484eb678ba20fa451073', 'api', -1, NULL, '查询帮助分类', 'queryHelpTypeList', 1, 2820, 4, b'0');
INSERT INTO `layout` VALUES ('55fd045cac664aea8704b7f821f074a2', 'default', -1, NULL, '发表话题(移动版)', 'queryAddTopic', 1, 460, 4, b'0');
INSERT INTO `layout` VALUES ('56ac118fbdc14057923af976ac5b92d0', 'default', -1, 'topicUnhideList.html', '话题取消隐藏用户列表', 'user/control/topicUnhideList', 0, 800, 1, b'0');
INSERT INTO `layout` VALUES ('57557f26652742b4bd2abe84ba24a054', 'api', -1, 'addPrivateMessage.html', '添加私信', 'user/control/addPrivateMessage', 0, 450, 1, b'0');
INSERT INTO `layout` VALUES ('59963311443649299e1d86ae80c8e33c', 'api', -1, 'answerReplyList.html', '我的答案回复', 'user/control/answerReplyList', 0, 2000, 1, b'0');
INSERT INTO `layout` VALUES ('5a4c852fc55f4ad9aade573003ddc546', 'default', -1, 'message.html', '默认消息页', 'message', 0, 150, 1, b'0');
INSERT INTO `layout` VALUES ('5b37a52dc0604914881d767664f39ca2', 'default', -1, NULL, '查询话题会员收藏总数', 'queryFavoriteCount', 1, 710, 4, b'0');
INSERT INTO `layout` VALUES ('5bb7f175bfb848dbb1fc8f1b0094a4f6', 'api', -1, 'commentList.html', '我的评论', 'user/control/commentList', 0, 180, 1, b'0');
INSERT INTO `layout` VALUES ('5bd647d07828441d86ec647466dba3b1', 'default', -1, 'newPublic_3.html', '页脚', 'newPublic_3', 0, 370, 5, b'0');
INSERT INTO `layout` VALUES ('5c7624ced2c845b28741c724594b6b0c', 'default', -1, 'userDynamicList.html', '用户动态列表', 'user/control/userDynamicList', 0, 900, 1, b'0');
INSERT INTO `layout` VALUES ('5d03785446d44a0a9dbcc3966ffb377c', 'default', -1, 'newPublic_1.html', '分页', 'newPublic_1', 0, 320, 5, b'0');
INSERT INTO `layout` VALUES ('5d6067bbc62646f7a22f8095cca01f98', 'default', -1, NULL, '会员卡(移动版)', 'queryMembershipCard', 1, 1720, 4, b'0');
INSERT INTO `layout` VALUES ('62077b6844e2413d9f5e73d1996c7ee9', 'default', -1, NULL, '发表答案回复(移动版)', 'queryAddAnswerReply', 1, 2080, 4, b'0');
INSERT INTO `layout` VALUES ('65735bf28feb47088a5102ff644a0d77', 'default', -1, NULL, '查询粉丝总数', 'queryFollowerCount', 1, 1110, 4, b'0');
INSERT INTO `layout` VALUES ('66a96e7ee8304694ba86dd75836afdcb', 'default', -1, NULL, '查询帮助分类(移动端)', 'queryHelpTypeList', 1, 2450, 4, b'0');
INSERT INTO `layout` VALUES ('68fabb2c63e942a48c0c8ff7c2dd99c3', 'api', -1, 'questionFavoriteList.html', '问题收藏列表', 'user/control/questionFavoriteList', 0, 2100, 1, b'0');
INSERT INTO `layout` VALUES ('69b1d61a5afa47a0a05760c5ac7ac282', 'default', -1, NULL, '答案列表(移动版)', 'queryAnswerList', 1, 2050, 4, b'0');
INSERT INTO `layout` VALUES ('69ee523bbe154dd5a506e1c0cebf71e8', 'default', -1, 'findPassWord_step2.html', '找回密码第二步', 'findPassWord/step2', 0, 137, 1, b'0');
INSERT INTO `layout` VALUES ('6ab3b63990bd43bd92c16b2373a09c8a', 'api', -1, NULL, '查询修改答案回复表单', 'user/queryEditAnswerReply', 1, 2780, 4, b'0');
INSERT INTO `layout` VALUES ('6b34109ea214408d9a215fab47b47016', 'api', -1, NULL, '查询帮助导航', 'queryHelpNavigation', 1, 2830, 4, b'0');
INSERT INTO `layout` VALUES ('6c6f77c044024be0a56486f0336df56c', 'default', -1, NULL, '查询是否已经关注该用户', 'queryFollowing', 1, 1120, 4, b'0');
INSERT INTO `layout` VALUES ('6c93b3c854804de983ccd807ade0da3c', 'default', -1, 'questionList.html', '我的问题', 'user/control/questionList', 0, 1800, 1, b'0');
INSERT INTO `layout` VALUES ('6f06fcbed64144d4a0a87d68e5e1ac5a', 'api', -1, NULL, '查询引用评论表单', 'user/queryQuoteComment', 1, 2600, 4, b'0');
INSERT INTO `layout` VALUES ('6f1b6d4452b64c5ea3cbffff1dab6b6e', 'default', -1, NULL, '发表评论(移动版) ', 'queryAddComment', 1, 470, 4, b'0');
INSERT INTO `layout` VALUES ('704793a98bc241e7869a5e72c6fa3600', 'api', -1, 'remindList.html', '提醒列表', 'user/control/remindList', 0, 550, 1, b'0');
INSERT INTO `layout` VALUES ('72242bb3ca3a463eae46ed0c07826f4f', 'default', -1, 'blank_3.html', '评论引用', 'comment_quote', 0, 350, 4, b'0');
INSERT INTO `layout` VALUES ('723dcb4988ab4d1eb1114f01c79f4402', 'api', -1, 'realNameAuthentication.html', '实名认证', 'user/control/realNameAuthentication', 0, 274, 1, b'0');
INSERT INTO `layout` VALUES ('725640fa18ce499e8c425689c8bdd134', 'default', -1, 'likeList.html', '点赞列表', 'user/control/likeList', 0, 1000, 1, b'0');
INSERT INTO `layout` VALUES ('730fec12b0e846a1acfa81e9c4c99efc', 'default', -1, NULL, '发表回复(移动版)', 'queryAddReply', 1, 490, 4, b'0');
INSERT INTO `layout` VALUES ('7747c7fa3dd6451783f94d01f1678a0b', 'default', -1, 'blank_1.html', '话题内容', 'thread', 0, 330, 4, b'0');
INSERT INTO `layout` VALUES ('78c4d33956394003927421d221d57dd1', 'default', -1, 'phoneBinding.html', '绑定手机', 'user/control/phoneBinding', 0, 275, 1, b'0');
INSERT INTO `layout` VALUES ('79065de632934072944d1dcfb224ea28', 'default', -1, NULL, '全部标签(移动版) ', 'allTag', 1, 430, 4, b'0');
INSERT INTO `layout` VALUES ('7c4b56d66c0e4b69ba3d8750ebff87f8', 'api', -1, 'topicUnhideList.html', '话题取消隐藏用户列表', 'user/control/topicUnhideList', 0, 800, 1, b'0');
INSERT INTO `layout` VALUES ('7c79820f306143378169167088f17cc2', 'default', -1, NULL, '查询全部问题标签(json)', 'queryAllQuestionTag', 1, 1780, 4, b'0');
INSERT INTO `layout` VALUES ('7f2d29e0c92d43b4844e0c9400b62ebd', 'default', -1, 'blank_5.html', '会员卡列表', 'membershipCardList', 0, 1310, 4, b'0');
INSERT INTO `layout` VALUES ('7f5b0839442446148b5f56f0f2648d45', 'default', -1, 'followList.html', '关注列表', 'user/control/followList', 0, 1200, 1, b'0');
INSERT INTO `layout` VALUES ('7f92073f42c84b67bf89b64b3ba3f5d1', 'default', -1, 'favoriteList.html', '收藏夹列表', 'user/control/favoriteList', 0, 600, 1, b'0');
INSERT INTO `layout` VALUES ('7fa8d0be2433401289eddf315eda75b4', 'default', -1, 'reportList.html', '举报列表', 'user/control/reportList', 0, 2500, 1, b'0');
INSERT INTO `layout` VALUES ('8033f5686cf7445cbb65fb6a0c184657', 'api', -1, 'reportList.html', '举报列表', 'user/control/reportList', 0, 2500, 1, b'0');
INSERT INTO `layout` VALUES ('80b64ce95e2b41848c8dfe13e76f6c0d', 'api', -1, NULL, '查询关注总数', 'queryFollowCount', 1, 2640, 4, b'0');
INSERT INTO `layout` VALUES ('82df735f38f245ccb8160120e717c9ba', 'default', -1, 'register.html', '注册页', 'register', 0, 130, 1, b'0');
INSERT INTO `layout` VALUES ('837ba035b57d4ff19358c0a10710313d', 'api', -1, 'updatePhoneBinding_step1.html', '更换绑定手机第一步', 'user/control/updatePhoneBinding/step1', 0, 276, 1, b'0');
INSERT INTO `layout` VALUES ('843e3bf4f6b645dca42522ee2779d691', 'default', -1, NULL, '查询用户问题收藏总数', 'queryQuestionFavoriteCount', 1, 2120, 4, b'0');
INSERT INTO `layout` VALUES ('85b9fb209cdb437e9f50e849d2c7402b', 'default', 3, 'more_help.html', '在线帮助\'更多\'', 'more', 0, 60, 1, b'0');
INSERT INTO `layout` VALUES ('88f5becc14d34ec6969feaf39a637b69', 'default', -1, NULL, '引用评论(移动版)', 'queryAddQuote', 1, 480, 4, b'0');
INSERT INTO `layout` VALUES ('890eb44b2c2d4b9db90955951a0123a4', 'api', -1, NULL, '查询修改答案表单', 'user/queryEditAnswer', 1, 2770, 4, b'0');
INSERT INTO `layout` VALUES ('894c1ee85cb34067a0f2c82364178a66', 'default', -1, 'blank_11.html', '答案回复', 'answer_reply', 0, 1790, 4, b'0');
INSERT INTO `layout` VALUES ('8b5dd591aa3548e78fd8688230f8cd76', 'default', -1, 'topicList.html', '我的话题', 'user/control/topicList', 0, 180, 1, b'0');
INSERT INTO `layout` VALUES ('8ba23e3d267c427da37de1b8b037edff', 'default', -1, 'findPassWord_step1.html', '找回密码第一步', 'findPassWord/step1', 0, 136, 1, b'0');
INSERT INTO `layout` VALUES ('8bf2670aafb9429a92a2dab3c1f08d60', 'default', -1, 'blank_6.html', '会员卡', 'membershipCard', 0, 1320, 4, b'0');
INSERT INTO `layout` VALUES ('8c25652471eb476b8f293f7bb20632ca', 'api', -1, NULL, '查询友情链接', 'queryLink', 1, 2500, 4, b'0');
INSERT INTO `layout` VALUES ('8fea6a5b0d4148cea24ed8c648c26107', 'default', -1, 'realNameAuthentication.html', '实名认证', 'user/control/realNameAuthentication', 0, 274, 1, b'0');
INSERT INTO `layout` VALUES ('90e9a5ef12b843adb3d282332fbd27df', 'default', -1, 'newPublic_2.html', '页头', 'newPublic_2', 0, 360, 5, b'0');
INSERT INTO `layout` VALUES ('917e2578460641838e8b93355744b748', 'api', -1, 'likeList.html', '点赞列表', 'user/control/likeList', 0, 1000, 1, b'0');
INSERT INTO `layout` VALUES ('91fcfa258f41472096f57db6308856cf', 'default', -1, NULL, '查询话题点赞总数', 'queryLikeCount', 1, 910, 4, b'0');
INSERT INTO `layout` VALUES ('9283ad4a07a343828c145200f1fd272c', 'api', -1, NULL, '查询粉丝总数', 'queryFollowerCount', 1, 2420, 4, b'0');
INSERT INTO `layout` VALUES ('96ada50db91c4afbb6c1074300939b22', 'default', -1, 'blank_18.html', '帮助内容', 'helpDetail', 0, 2440, 4, b'0');
INSERT INTO `layout` VALUES ('9954217a647445648bf46666c826bed4', 'api', -1, NULL, '查询添加评论表单', 'queryAddComment', 1, 2580, 4, b'0');
INSERT INTO `layout` VALUES ('9a4c7ba616db4c1489a5ab3b3587ed12', 'api', -1, NULL, '查询添加答案表单', 'user/queryAddAnswer', 1, 2740, 4, b'0');
INSERT INTO `layout` VALUES ('9b78793395bd415fa6349d889226089c', 'api', -1, NULL, '查询是否已经关注该用户', 'queryFollowing', 1, 2430, 4, b'0');
INSERT INTO `layout` VALUES ('9e9cafbe93314ca585aedbe98f3b4e11', 'default', -1, 'blank_10.html', '发表问题', 'user/addQuestion', 0, 1770, 4, b'0');
INSERT INTO `layout` VALUES ('9fdd67aa7e3d4dd7aabbe1ab0fd324e5', 'default', -1, 'answerReplyList.html', '我的答案回复', 'user/control/answerReplyList', 0, 2000, 1, b'0');
INSERT INTO `layout` VALUES ('a14b8228d72b4c72b306111be88fc1bb', 'default', -1, 'membershipCardOrderList.html', '会员卡订单列表', 'user/control/membershipCardOrderList', 0, 1700, 1, b'0');
INSERT INTO `layout` VALUES ('a4a0399a222f48039c84acd45e4df52f', 'default', -1, 'addPrivateMessage.html', '添加私信', 'user/control/addPrivateMessage', 0, 450, 1, b'0');
INSERT INTO `layout` VALUES ('a4fe0c6f3c2a4b1eb776065c702781b3', 'api', -1, NULL, '全部标签', 'allTag', 1, 2480, 4, b'0');
INSERT INTO `layout` VALUES ('a70dcb211a154bbba81697508113668b', 'default', -1, NULL, '话题内容(移动版)', 'queryTopicContent', 1, 440, 4, b'0');
INSERT INTO `layout` VALUES ('a808d04033b74c288cd7e5226d222176', 'default', -1, NULL, '查询第三方登录', 'queryThirdPartyLogin', 1, 2170, 4, b'0');
INSERT INTO `layout` VALUES ('a86967d780014f3d850efcf9d5b0fcba', 'default', -1, 'blank_16.html', '修改答案回复', 'user/editAnswerReply', 0, 2190, 4, b'0');
INSERT INTO `layout` VALUES ('a8e08924952e4501ae1c19766487bfb3', 'api', -1, NULL, '查询添加答案回复表单', 'user/queryAddAnswerReply', 1, 2760, 4, b'0');
INSERT INTO `layout` VALUES ('a920fd623ff74d7b97f25378c3567f0c', 'api', -1, NULL, '查询话题会员收藏总数', 'queryFavoriteCount', 1, 2520, 4, b'0');
INSERT INTO `layout` VALUES ('abb3fc5ca2354ea287fd87d816c2d0bb', 'default', -1, 'commentList.html', '我的评论', 'user/control/commentList', 0, 180, 1, b'0');
INSERT INTO `layout` VALUES ('aca9f3a710f14f61934c49c257d35002', 'api', -1, NULL, '查询帮助', 'queryHelp', 1, 2850, 4, b'0');
INSERT INTO `layout` VALUES ('acbffd6b80804f58a3457edf57b5ee1d', 'default', -1, 'privateMessageChatList.html', '私信对话列表', 'user/control/privateMessageChatList', 0, 400, 1, b'0');
INSERT INTO `layout` VALUES ('ae570158ef4848a3acffe14b870eda86', 'default', -1, 'redEnvelopeAmountDistributionList.html', '发红包金额分配列表', 'user/control/redEnvelopeAmountDistributionList', 0, 2300, 1, b'0');
INSERT INTO `layout` VALUES ('afd68d68b7e4405ca555fa1fafb3681e', 'api', -1, NULL, '查询话题内容', 'thread', 1, 2450, 4, b'0');
INSERT INTO `layout` VALUES ('b017258bf1b244ed8a86d24eda1ad3bf', 'api', -1, NULL, '查询问题用户收藏总数', 'queryQuestionFavoriteCount', 1, 2730, 4, b'0');
INSERT INTO `layout` VALUES ('b16e8eee7474475cbc0fc9b81e2ea603', 'default', -1, 'giveRedEnvelopeList.html', '发红包列表', 'user/control/giveRedEnvelopeList', 0, 2200, 1, b'0');
INSERT INTO `layout` VALUES ('b2fbec2d094d41e49e7d1111c120098c', 'default', -1, 'replyList.html', '我的回复', 'user/control/replyList', 0, 180, 1, b'0');
INSERT INTO `layout` VALUES ('b3211fc921684203a0b5e5960e140274', 'api', -1, NULL, '查询相似问题', 'queryLikeQuestion', 1, 2790, 4, b'0');
INSERT INTO `layout` VALUES ('b35b9b31d4584b65a1109203b6119476', 'default', -1, NULL, '修改评论回复(移动版)', 'queryEditCommentReply', 1, 2160, 4, b'0');
INSERT INTO `layout` VALUES ('b3ce59d4049a4a609a70480681b3d119', 'api', -1, NULL, '查询话题修改回复表单', 'user/queryEditReply', 1, 2620, 4, b'0');
INSERT INTO `layout` VALUES ('b5b0e4b3c19145b497bc7cb529bf2519', 'default', -1, 'privateMessageList.html', '私信列表', 'user/control/privateMessageList', 0, 350, 1, b'0');
INSERT INTO `layout` VALUES ('b7fb6d10945342d9be7366f0fe79426d', 'api', -1, 'receiveRedEnvelopeList.html', '收红包列表', 'user/control/receiveRedEnvelopeList', 0, 2400, 1, b'0');
INSERT INTO `layout` VALUES ('b8aea98e976b45b0933c2e6c79e1b5aa', 'api', -1, 'point.html', '积分', 'user/control/point', 0, 220, 1, b'0');
INSERT INTO `layout` VALUES ('b9070f6f929c4a7999d5c8aa2ac29b45', 'api', -1, 'editUser.html', '修改会员', 'user/control/editUser', 0, 270, 1, b'0');
INSERT INTO `layout` VALUES ('b9cb01a67efc459b8ef3ba5c88e5ab6e', 'api', -1, 'membershipCardOrderList.html', '会员卡订单列表', 'user/control/membershipCardOrderList', 0, 1700, 1, b'0');
INSERT INTO `layout` VALUES ('b9d3684fd5004247b4820ca5b9a5bff3', 'default', -1, NULL, '查询回答总数', 'queryAnswerCount', 1, 2020, 4, b'0');
INSERT INTO `layout` VALUES ('ba307b042784455aa64cf886d0fce20e', 'api', -1, NULL, '查询会员卡列表', 'queryMembershipCardList', 1, 2800, 4, b'0');
INSERT INTO `layout` VALUES ('ba85aac8b3924ea980ad39087d0a722f', 'default', -1, 'systemNotifyList.html', '系统通知列表', 'user/control/systemNotifyList', 0, 500, 1, b'0');
INSERT INTO `layout` VALUES ('babfe2e086b34463933149b07932e265', 'api', -1, NULL, '查询问题内容', 'question', 1, 2460, 4, b'0');
INSERT INTO `layout` VALUES ('baecca44ee9b4b3bb6f6cada63b70389', 'api', -1, NULL, '查询话题点赞总数', 'queryLikeCount', 1, 2540, 4, b'0');
INSERT INTO `layout` VALUES ('bc920d0af10443828316bbc8bcb2b4c3', 'default', -1, 'payment.html', '付款页面', 'user/control/payment', 0, 1500, 1, b'0');
INSERT INTO `layout` VALUES ('bfb54b63a24c4c9c91775991d0f53dcc', 'api', -1, NULL, '查询相似话题', 'queryLikeTopic', 1, 2670, 4, b'0');
INSERT INTO `layout` VALUES ('bfe17faef78d4971b14e598541ba3414', 'api', -1, 'login.html', '登录页', 'login', 0, 160, 1, b'0');
INSERT INTO `layout` VALUES ('c22f985f3d0a436ba0b5c6479a121f5b', 'api', -1, NULL, '查询用户是否已收藏该话题', 'queryAlreadyCollected', 1, 2530, 4, b'0');
INSERT INTO `layout` VALUES ('c53be46778cb48eb8971a18a4ee2680f', 'api', -1, 'favoriteList.html', '收藏夹列表', 'user/control/favoriteList', 0, 600, 1, b'0');
INSERT INTO `layout` VALUES ('c5d387ee29764c2a829278a17c629e17', 'api', -1, NULL, '查询领取红包用户', 'queryReceiveRedEnvelopeUser', 1, 2660, 4, b'0');
INSERT INTO `layout` VALUES ('c677cbc3806e4cd191523eb758c538b0', 'api', -1, NULL, '查询举报表单', 'user/queryAddReport', 1, 2870, 4, b'0');
INSERT INTO `layout` VALUES ('c686755a48ca4ca191d7380545a9f56a', 'api', -1, 'findPassWord_step2.html', '找回密码第二步', 'findPassWord/step2', 0, 137, 1, b'0');
INSERT INTO `layout` VALUES ('c7b55917354243199f3c354532957590', 'default', -1, 'receiveRedEnvelopeList.html', '收红包列表', 'user/control/receiveRedEnvelopeList', 0, 2400, 1, b'0');
INSERT INTO `layout` VALUES ('c8ad33d6f9a24809ae348ce44de1b4c1', 'default', -1, NULL, '查询帮助导航(移动端)', 'queryHelpNavigation', 1, 2480, 4, b'0');
INSERT INTO `layout` VALUES ('c9a85b0657264a5aac06cf7e6555d5ff', 'api', -1, 'topicList.html', '我的话题', 'user/control/topicList', 0, 180, 1, b'0');
INSERT INTO `layout` VALUES ('cef07a74185940109969afa9f3899899', 'api', -1, 'message.html', '默认消息页', 'message', 0, 150, 1, b'0');
INSERT INTO `layout` VALUES ('d07b94ad410e43fdab473029f44c67c8', 'api', -1, NULL, '查询热门话题', 'queryHotTopic', 1, 2880, 4, b'0');
INSERT INTO `layout` VALUES ('d40efbb845cc446ea520eec7e732cf4f', 'default', -1, 'questionFavoriteList.html', '问题收藏列表', 'user/control/questionFavoriteList', 0, 2100, 1, b'0');
INSERT INTO `layout` VALUES ('d548ee0e9d84456c8f616671022d043b', 'default', -1, NULL, '查询会员卡列表(移动版)', 'queryMembershipCardList', 1, 1710, 4, b'0');
INSERT INTO `layout` VALUES ('d5bad6d68fc24cafbbe2b8920c9d289c', 'api', -1, 'questionList.html', '我的问题', 'user/control/questionList', 0, 1800, 1, b'0');
INSERT INTO `layout` VALUES ('d627809654484be288ae30b32457a2d6', 'default', -1, NULL, '查询领取红包用户列表', 'queryReceiveRedEnvelopeUser', 1, 2410, 4, b'0');
INSERT INTO `layout` VALUES ('d734da046f784ff2a80dc79515b93646', 'default', -1, NULL, '发表答案(移动版)', 'queryAddAnswer', 1, 2070, 4, b'0');
INSERT INTO `layout` VALUES ('d738e25ac96e4e74812cdf63a639352e', 'api', -1, NULL, '查询发红包内容', 'queryGiveRedEnvelopeContent', 1, 2650, 4, b'0');
INSERT INTO `layout` VALUES ('d7e5fcb22e1b463cb2616616e42d3b63', 'default', -1, 'blank_9.html', '问题内容', 'question', 0, 1760, 4, b'0');
INSERT INTO `layout` VALUES ('d8a30fd190ad4fd1a89a5d8f9c7df573', 'api', -1, NULL, '查询追加问题表单', 'user/queryAppendQuestion', 1, 2710, 4, b'0');
INSERT INTO `layout` VALUES ('d9bc3f88bc184f6a98a8bf2d7429653e', 'default', -1, 'jump.html', '默认跳转页', 'jump', 0, 140, 1, b'0');
INSERT INTO `layout` VALUES ('dbda9575f6e0415fa1bfee47f3301293', 'api', -1, 'phoneBinding.html', '绑定手机', 'user/control/phoneBinding', 0, 275, 1, b'0');
INSERT INTO `layout` VALUES ('dc8425d53c864352b24969d889177321', 'default', -1, 'blank_13.html', '修改评论', 'user/editComment', 0, 2130, 4, b'0');
INSERT INTO `layout` VALUES ('de0e6f72232547798f687a5ac54092d4', 'api', -1, 'agreement.html', '用户协议', 'agreement', 0, 135, 1, b'0');
INSERT INTO `layout` VALUES ('e165692880c2439ea24164a545477616', 'default', -1, 'paymentCompleted.html', '付款完成页面', 'paymentCompleted', 0, 1600, 1, b'0');
INSERT INTO `layout` VALUES ('e3f72ab4c65745a8a2a4bdd8ffa65a04', 'default', -1, NULL, '修改评论(移动版)', 'queryEditComment', 1, 2150, 4, b'0');
INSERT INTO `layout` VALUES ('e447aa94ad9e47e4be5d58482d75dc23', 'default', -1, 'blank_2.html', '评论回复', 'comment_reply', 0, 340, 4, b'0');
INSERT INTO `layout` VALUES ('e55ba5ae4efe4ba4b55857d00cfaab0d', 'default', -1, 'search.html', '话题搜索页', 'search', 0, 30, 1, b'0');
INSERT INTO `layout` VALUES ('e6da1f7084864f91992a61f32fbaafc0', 'default', -1, NULL, '查询发红包(移动端)', 'queryGiveRedEnvelope', 1, 2420, 4, b'0');
INSERT INTO `layout` VALUES ('e8126fd3b06645b1963d0dc7a6f96e65', 'api', -1, NULL, '查询添加话题表单', 'user/queryAddTopic', 1, 2510, 4, b'0');
INSERT INTO `layout` VALUES ('e906542026964981b8251aac0894c494', 'default', -1, 'blank_4.html', '在线留言', 'feedback', 0, 500, 4, b'0');
INSERT INTO `layout` VALUES ('ea282240f21c46688de3e70a6a9e1925', 'api', -1, NULL, '查询回答总数', 'queryAnswerCount', 1, 2630, 4, b'0');
INSERT INTO `layout` VALUES ('eb22678d375740a78e11c5cbcb24be0d', 'api', -1, NULL, '话题列表', 'queryTopicList', 1, 2490, 4, b'0');
INSERT INTO `layout` VALUES ('eccf8e7e476c4714845687037d6daf96', 'default', -1, NULL, '查询用户是否已收藏问题', 'queryAlreadyFavoriteQuestion', 1, 2110, 4, b'0');
INSERT INTO `layout` VALUES ('eee858f7902c49e5b7adf4e23fc41960', 'default', -1, NULL, '追加提问(移动版)', 'queryAppendQuestion', 1, 2100, 4, b'0');
INSERT INTO `layout` VALUES ('f119cd0e918742838000f096ec42358d', 'api', -1, NULL, '第三方登录', 'queryThirdPartyLogin', 1, 2440, 4, b'0');
INSERT INTO `layout` VALUES ('f1e60813417c4c12840613da6b01726c', 'api', -1, NULL, '查询用户是否已经点赞该话题', 'queryAlreadyLiked', 1, 2550, 4, b'0');
INSERT INTO `layout` VALUES ('f24e26d8f5fb4f408f32fdff4089d083', 'default', -1, 'answerList.html', '我的答案', 'user/control/answerList', 0, 1900, 1, b'0');
INSERT INTO `layout` VALUES ('f7676ca40900427e821f2999185d1ca0', 'api', -1, NULL, '问题列表', 'queryQuestionList', 1, 2690, 4, b'0');
INSERT INTO `layout` VALUES ('f7db737de89b410d8416f271247a3cad', 'api', -1, NULL, '查询提问题表单', 'user/queryAddQuestion', 1, 2700, 4, b'0');
INSERT INTO `layout` VALUES ('f7efe75775064ae496f9008e220ec3f5', 'api', -1, 'redEnvelopeAmountDistributionList.html', '发红包金额分配列表', 'user/control/redEnvelopeAmountDistributionList', 0, 2300, 1, b'0');
INSERT INTO `layout` VALUES ('fad5de351ed7453d95f53e5b5efdf0dc', 'api', -1, 'jump.html', '默认跳转页', 'jump', 0, 140, 1, b'0');
INSERT INTO `layout` VALUES ('fb7526585c4d4ffa9e19a5bbfcadd730', 'api', -1, NULL, '查询话题添加回复表单', 'user/queryAddReply', 1, 2610, 4, b'0');
INSERT INTO `layout` VALUES ('fbbbf2ec6fbe43f79b489b8cce26f2a6', 'api', -1, NULL, '评论列表', 'queryCommentList', 1, 2570, 4, b'0');
INSERT INTO `layout` VALUES ('fc0b41f454dd4a10916be238d295a0b9', 'default', -1, 'editUser.html', '修改会员', 'user/control/editUser', 0, 270, 1, b'0');
INSERT INTO `layout` VALUES ('fd72dab269d94795ac112b59364017ed', 'api', -1, NULL, '服务条款', 'queryTermsService', 1, 2470, 4, b'0');
INSERT INTO `layout` VALUES ('ffbc4af71a024cbd861e5dd621bf45a1', 'default', -1, 'topicLikeList.html', '话题点赞列表', 'user/control/topicLikeList', 0, 1100, 1, b'0');
INSERT INTO `layout` VALUES ('ffd38d63c405486f800d29cc43f804db', 'api', -1, 'followList.html', '关注列表', 'user/control/followList', 0, 1200, 1, b'0');
...
CREATE TABLE `like_0`  (
  ...
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `answerId` bigint(0) NULL DEFAULT NULL,
  `answerReplyId` bigint(0) NULL DEFAULT NULL,
  `commentId` bigint(0) NULL DEFAULT NULL,
  `commentReplyId` bigint(0) NULL DEFAULT NULL,
  `module` int(0) NULL DEFAULT NULL,
  `questionId` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `like_1_idx`(`userName`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mediaprocessqueue`  (
  ...
  `ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `mediaProcessQueue_2_idx`(`fileName`) USING BTREE,
  INDEX `mediaProcessQueue_1_idx`(`processProgress`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mediaprocesssetting`  (
  ...
  `segmentLocation` int(0) NULL DEFAULT NULL,
  `segmentTime` int(0) NULL DEFAULT NULL,
  `version` bigint(0) NULL DEFAULT NULL,
  `videoFrameRate` int(0) NULL DEFAULT NULL,
  `watermark` bit(1) NULL DEFAULT NULL,
  `watermarkDistance_x` int(0) NULL DEFAULT NULL,
  `watermarkDistance_y` int(0) NULL DEFAULT NULL,
  `watermarkFullPathName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `watermarkPosition` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `membershipcard`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `membershipCard_1_idx`(`createDate`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `membershipcardgiftitem_0`  (
  ...
  `membershipCardGiftTaskId` bigint(0) NULL DEFAULT NULL,
  `postTime` datetime(0) NULL DEFAULT NULL,
  `type` int(0) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `membershipCardGiftItem_idx`(`membershipCardGiftTaskId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `membershipcardgifttask`  (
  ...
  `type` int(0) NULL DEFAULT NULL,
  `unit` int(0) NULL DEFAULT NULL,
  `expirationDate_end` datetime(0) NULL DEFAULT NULL,
  `expirationDate_start` datetime(0) NULL DEFAULT NULL,
  `restriction` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `version` int(0) NULL DEFAULT NULL,
  `userRoleId` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userRoleName` varchar(192) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `membershipCardGiftTask_1_idx`(`expirationDate_start`, `expirationDate_end`, `type`, `enable`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `membershipcardorder`  (
  ...
  `accountPoint` bigint(0) NULL DEFAULT NULL,
  `createDate` datetime(0) NULL DEFAULT NULL,
  `duration` int(0) NULL DEFAULT NULL,
  `membershipCardId` bigint(0) NULL DEFAULT NULL,
  `paymentAmount` decimal(12, 2) NOT NULL,
  `paymentPoint` bigint(0) NULL DEFAULT NULL,
  `quantity` int(0) NULL DEFAULT NULL,
  `roleName` varchar(192) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `specificationId` bigint(0) NULL DEFAULT NULL,
  ...
  INDEX `membershipCardOrder_1_idx`(`userName`, `createDate`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `onlinepaymentinterface`  (
  ...
  `enable` bit(1) NOT NULL,
  `interfaceProduct` int(0) NULL DEFAULT NULL,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `sort` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `paymentlog_0`  (
  ...
  `amountState` int(0) NOT NULL,
  `interfaceProduct` int(0) NULL DEFAULT NULL,
  `operationUserName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `operationUserType` int(0) NULL DEFAULT NULL,
  `paymentModule` int(0) NULL DEFAULT NULL,
  ...
  INDEX `paymentlog_idx`(`userName`, `times`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `paymentverificationlog`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `parameterId` bigint(0) NULL DEFAULT NULL,
  `paymentAmount` decimal(12, 2) NOT NULL,
  `paymentModule` int(0) NULL DEFAULT NULL,
  `times` datetime(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userName_idx`(`parameterId`, `userName`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `pointlog_0`  (
  ...
  `pointState` int(0) NOT NULL,
  `remark` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `times` datetime(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pointlog_idx`(`userName`, `times`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `pointlog_1` VALUES ('acea5c630d38475d8653f7278648a4b40001', 'S30haD6EltuuM6z7CD4', 2, 2, 100, 10, 1, '', '2024-08-07 11:22:22', 'S30haD6EltuuM6z7CD4');
INSERT INTO `pointlog_1` VALUES ('d905321dae9340e58438b6ff24dfa46a0001', 'S30haD6EltuuM6z7CD4', 2, 1, 200, 5, 1, '', '2024-08-07 11:01:36', 'S30haD6EltuuM6z7CD4');
...
-- ----------------------------
INSERT INTO `pointlog_2` VALUES ('350a26c28efe406cb6bc80a095b673830002', 'VUWuDd534ygxgEaaVJv', 2, 3, 100, 10, 1, '', '2024-08-11 17:14:39', 'VUWuDd534ygxgEaaVJv');
INSERT INTO `pointlog_2` VALUES ('82d6003fba0f4f629d679e43f06570530002', 'VUWuDd534ygxgEaaVJv', 2, 5, 200, 5, 1, '', '2024-08-11 17:25:40', 'VUWuDd534ygxgEaaVJv');
...
-- ----------------------------
INSERT INTO `pointlog_3` VALUES ('7b1c86895b3d47faba0ef73c2fb52df10003', 'gMLDMPa0UGxAbMQM9NM', 2, 4, 300, 5, 1, '', '2024-08-11 17:24:40', 'gMLDMPa0UGxAbMQM9NM');
INSERT INTO `pointlog_3` VALUES ('82c90448cfc84b76937747f5e719d5700003', 'gMLDMPa0UGxAbMQM9NM', 2, 4, 100, 10, 1, '', '2024-08-11 17:22:53', 'gMLDMPa0UGxAbMQM9NM');
...
CREATE TABLE `privatemessage_0`  (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `friendUserId` bigint(0) NULL DEFAULT NULL,
  `messageContent` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `readTimeFormat` bigint(0) NULL DEFAULT NULL,
  `receiverUserId` bigint(0) NULL DEFAULT NULL,
  `sendTimeFormat` bigint(0) NULL DEFAULT NULL,
  `senderUserId` bigint(0) NULL DEFAULT NULL,
  `status` int(0) NULL DEFAULT NULL,
  `userId` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `privateMessage_1_idx`(`userId`, `status`, `sendTimeFormat`) USING BTREE,
  INDEX `privateMessage_2_idx`(`userId`, `friendUserId`, `status`, `sendTimeFormat`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `pv`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pv_1_idx`(`times`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pv
-- ----------------------------
INSERT INTO `pv` VALUES ('000f451aa9574ec099de2c6b4c46b96e', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-07 11:22:46', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('0185092456a84fae880307022973f649', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/register?jumpUrl=aW5kZXg', '2024-08-11 17:22:24', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('0397b66335404430afd3687fafa24f6d', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 10:59:03', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('0517f7237e5347b882f4e2f1106c57ef', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:07:24', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('0b2378f11a5642a59f7cfbfc1b7876ac', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:34:24', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('0c59169cdc924dd4add5a7a027feadc0', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-07 10:58:34', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('0dd2b16cbafb443795327a8b8b8db26e', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:13:01', 'http://localhost:8080/login?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('0f49aa0d2e3b4136b8f618bd42c2d379', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:06:53', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('1460cf0f278b4045993f105bf508245e', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-07 11:21:54', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('149f406ac8ec4d75abc1973b30a80992', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/help', '2024-08-07 10:58:18', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('1548250a50e3438e881b22479ad10714', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 10:58:10', 'http://localhost:8080/user/control/home');
INSERT INTO `pv` VALUES ('1860552769854517bdc2b586f1ff830a', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:49:10', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('1aad3881301040498c33a9317a9caa84', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:07:24', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('1cba1771794a414b920b65b5aadf72bd', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/search?keyword=%E7%94%9F%E6%B4%BB', '2024-08-07 11:23:02', 'http://localhost:8080/user/control/home');
INSERT INTO `pv` VALUES ('1cd94d2b386f4eae88634a5fa92eb973', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=1', '2024-08-07 11:01:54', 'http://localhost:8080/thread?topicId=1');
INSERT INTO `pv` VALUES ('1db797fd32ab47dc93e1ac322f253e46', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-11 17:17:17', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('1dcb92cf6ba74575b741d30c2600f3ad', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:23:05', 'http://localhost:8080/user/control/home?userName=gMLDMPa0UGxAbMQM9NM');
INSERT INTO `pv` VALUES ('1e0ece689dfb4aaead057f0b77f8939a', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-07 11:21:50', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('1e1e7b7524e5423f94ebe6403fcf91b8', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/membershipCardList', '2024-08-11 17:20:10', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('20aebbae33494ced812637614ce778a4', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:21:12', 'http://localhost:8080/register?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('22e0185faf5448c58f43512b6d8d0a94', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:21:26', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('2511a8dacb0347dcbe10ef482b1fce5a', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 10:59:03', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('26cc52dc68054d3a844ee543301644c9', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:22:01', 'http://localhost:8080/register?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('29ae53bec8fc49d8a5f5fc4afd9a0382', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/login?jumpUrl=aW5kZXg', '2024-08-11 17:13:06', 'http://localhost:8080/register');
INSERT INTO `pv` VALUES ('2fba062479ad4d96bf148ba604ecdc99', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:07:24', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('3154a885bdfa48128e0020bbe3c2e057', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=1', '2024-08-07 11:01:54', 'http://localhost:8080/thread?topicId=1');
INSERT INTO `pv` VALUES ('32b3ac24ab2649a09870b35d20781bfb', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:15:19', 'http://localhost:8080/login?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('3458bb3a726a4ecc87ca99f2953e097e', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:21:23', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('37f7b8019d804ed094b1025fd860ff6f', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=4', '2024-08-11 17:25:51', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('38c1a3e574c4436983ecbdffdb3d4387', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:18:16', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('391615a528c2462c8c2e1f089e1ad449', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:16:02', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('391ad757182f42599bd27415c74dde58', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-07 09:58:22', 'http://localhost:8080/login?jumpUrl=dXNlci8x');
INSERT INTO `pv` VALUES ('39fa80a4df98492085c178b60d555f4e', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/login?jumpUrl=aW5kZXg', '2024-08-11 17:23:14', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('3cb86843edb44e4183fcba97aa0ef9f1', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=1', '2024-08-07 11:01:23', 'http://localhost:8080/login?jumpUrl=dGhyZWFkP3RvcGljSWQ9MQ');
INSERT INTO `pv` VALUES ('3f2187848c584f14bd7712d5a9f68c68', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:07:24', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('3f33da0e125f450995cfe8300226362d', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/membershipCardList', '2024-08-07 11:22:54', 'http://localhost:8080/search?keyword=%E7%94%9F%E6%B4%BB');
INSERT INTO `pv` VALUES ('404fd72f10d04d49b9d377f7cd4d1898', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 11:22:28', 'http://localhost:8080/user/control/home?userName=S30haD6EltuuM6z7CD4');
INSERT INTO `pv` VALUES ('43101d85f8b64161b899e47ab50f5894', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=1', '2024-08-07 11:01:48', 'http://localhost:8080/thread?topicId=1');
INSERT INTO `pv` VALUES ('4476499ca4d14fb3ae6c208e1291eeb8', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 11:22:25', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('44b8af6cf0594342b6490b00051a9492', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/membershipCardList', '2024-08-11 17:06:50', 'http://localhost:8080/help');
INSERT INTO `pv` VALUES ('44c113f8803045e086553d6f0ad7a799', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-11 17:12:24', 'http://localhost:8080/admin');
INSERT INTO `pv` VALUES ('45ad51e0d4654eca852c19cf3986410a', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:49:20', 'http://localhost:8080/feedback');
INSERT INTO `pv` VALUES ('46e17aa7668f401bb4657fe5d19358dc', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:43:18', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('479a9c81131d449db5f6060cc69682fb', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/help', '2024-08-07 11:22:37', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('47fab04658ad47b89afba3c688a26bb6', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-07 11:22:34', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('49845503df3347a595d2cab6f9ef59fd', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:44:37', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('49d2285d728448f5bb06ea310cb78bda', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:07:23', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('4a891d991c8449bea5265638ba946843', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:47:21', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('4b0b8eeb4f47422bab14e8ca3cbe8c17', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-11 17:12:03', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('4d4fffd35f50484ca605712067ffd640', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=4', '2024-08-11 17:24:37', 'http://localhost:8080/comment_reply?commentId=4&timestamp=1723368276978');
INSERT INTO `pv` VALUES ('4d9a5ffaf4934ee2a961e46b6a150460', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-11 17:15:15', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('4dc1e23bf7364916bf214ee989d82777', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-07 11:01:15', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('4fd20321c3ff44aab1a850bbd48abb17', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=1', '2024-08-07 11:01:55', 'http://localhost:8080/thread?topicId=1');
INSERT INTO `pv` VALUES ('5013612efca8460fa3296b7cd1ccd125', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/membershipCardList', '2024-08-07 10:58:16', 'http://localhost:8080/help');
INSERT INTO `pv` VALUES ('53700f5676c24f50890d3f79c7c6e96f', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/membershipCardList', '2024-08-07 10:58:32', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('53957ea7007a456bba7af1b6db5ece42', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/home?userName=gMLDMPa0UGxAbMQM9NM', '2024-08-11 17:24:25', 'http://localhost:8080/user/control/userDynamicList');
INSERT INTO `pv` VALUES ('54066f69adfe417588b5f124cd98343b', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:13:39', 'http://localhost:8080/register?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('54f335fba7634f8cb7c3402f95fa6e3d', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/home?userName=S30haD6EltuuM6z7CD4', '2024-08-07 11:22:31', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('56ec4ded499c4a1a890bb41358c9abc6', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/help', '2024-08-11 17:06:51', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('5ac6cfbf7fc245c7b591110c80613bea', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 10:58:08', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('5b238abf3b134c9b9175b43c504444db', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:43:19', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('5b36a41676c141c1b34d420c4b9b342a', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 11:22:45', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('5ca677f2ce714e4d89c02219795cd8c1', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/feedback', '2024-08-11 16:51:26', 'http://localhost:8080/login?jumpUrl=ZmVlZGJhY2s');
INSERT INTO `pv` VALUES ('5d66d46c378a4b198654a5a03818b494', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 10:59:07', 'http://localhost:8080/login?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('5d85abd25dfc4a4986899d0443323109', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-11 16:21:12', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('5f56d00e6fa248de858430ae0f42fc13', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 11:22:33', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('611cf0cc59ba48c9a069f9bda5749f56', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/topicList', '2024-08-11 17:16:14', 'http://localhost:8080/user/control/topicFavoriteList?topicId=3');
INSERT INTO `pv` VALUES ('612249c7a58c46519cbd610d1d888d95', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/login?jumpUrl=aW5kZXg', '2024-08-11 17:25:20', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('620f4ea2b35d428d942a3ec15e8499b8', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-07 11:02:19', 'http://localhost:8080/feedback');
INSERT INTO `pv` VALUES ('65d215f5846f440abd62ba6f91eb7177', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-07 10:55:33', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('6a8bd5b870c140beba2cccc4dcb1de82', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:34:25', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('6b985bb4511e4db7ac75a072d21025cd', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/membershipCardList', '2024-08-07 11:22:35', 'http://localhost:8080/help');
INSERT INTO `pv` VALUES ('6bfbfe373fa64e5a8a6cbf60dbe97a03', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 17:12:09', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('6e7667dd3ea14f9cb578bb17c765fb3e', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/feedback', '2024-08-11 17:05:30', 'http://localhost:8080/login?jumpUrl=ZmVlZGJhY2s');
INSERT INTO `pv` VALUES ('70135ae07c394989be797c4f1cd97b48', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 10:57:46', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('73462d5f2f424791b30d1d7627e4fb84', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-07 10:56:48', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('749b6cdb677f40ad8d17c0ddf63cf73a', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:06:48', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('7c7b32e5c21f449c95f423abb2983d02', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-11 17:16:34', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('7ebdedc72e364b5781fb768b9ce38bf5', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:43:14', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('80970110f87344269f5d37a03551810a', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/userDynamicList', '2024-08-07 10:58:15', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('8293010a71174622a407c9f1754ecbc3', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:44:42', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('83d9c8b7e1e841a9a3d69d05c91966b8', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:07:24', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('8544665ec8a5489c862b9c6f6db27eec', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:28:01', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('8a24a9991b3f424e9fc60e50b073138d', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:44:41', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('8d4a6bd3823540b790abd23f11b460d6', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/home', '2024-08-11 17:16:09', 'http://localhost:8080/user/control/topicList');
INSERT INTO `pv` VALUES ('8d79d68fa64d4957a490a4c060f4d8dc', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:06:54', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('8e42d873987b48028f7b8ce37941ee48', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:22:56', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('901aa6a990b74f67a5d8c4a74ecab30c', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=1', '2024-08-07 11:01:53', 'http://localhost:8080/thread?topicId=1');
INSERT INTO `pv` VALUES ('906f09a31b1d4b7aa41d91adc7a8815d', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/topicList', '2024-08-11 17:16:21', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('9079bcd7f86a4ead83ea9a7e23e83f80', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:16:38', 'http://localhost:8080/login?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('91fe5a446dee4550b6682ae34e05a1be', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-11 16:24:39', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('928f473adc104bdd91baa6044ca114ad', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/login?jumpUrl=ZmVlZGJhY2s', '2024-08-11 17:06:44', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('937fe8a8563540fd812a666be3c7a5ac', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:34:23', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('95737d805d6545048d25f4f1aeabf9a1', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:34:26', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('9d51a95a864f420e927668a1c91b667e', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:43:19', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('9e2e49103d6e4d85a836e11014505299', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 10:56:45', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('a0640827d2d74406a5699f31496688ed', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:34:22', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('a0d09cd318524f9bb9e1256919214660', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:30:35', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('a10f7a9aebaf4f7fa1a6e26dbd421baf', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:15:59', 'http://localhost:8080/?tagId=46072076566156');
INSERT INTO `pv` VALUES ('a1d3fa2beea04d63b043584570d6aeb5', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 10:56:45', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('a3bc57c9c82a47feaf714f18e071219c', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:25:29', 'http://localhost:8080/user/control/home?userName=gMLDMPa0UGxAbMQM9NM');
INSERT INTO `pv` VALUES ('a4f4e849a007462db1adccbed916c7db', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-07 10:55:35', 'http://localhost:8080/register?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('a7154732f5b545119fff779bb6163a87', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-11 17:20:26', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('a73d21e864be494c809bbbca49576593', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:15:58', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('a7fabe2f83a449668b8ebc527e588f76', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-07 11:01:20', 'http://localhost:8080/thread?topicId=1');
INSERT INTO `pv` VALUES ('a8fe40eac22d41b1812f6db49ca9ad07', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/membershipCardList', '2024-08-11 17:06:52', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('a90dc35cffa14749a671fa7f05507e9c', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:12:56', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('aaeeae929ff741f49b6a34ca50c030c6', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/login?jumpUrl=aW5kZXg', '2024-08-11 17:16:42', 'http://localhost:8080/register');
INSERT INTO `pv` VALUES ('add2cecfc808401b8516aecb75391504', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:20:11', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('af42657ac2774e9c99bb2e11249f72be', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/register?jumpUrl=aW5kZXg', '2024-08-11 17:14:25', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('b0fd833df9dd49eeb360ad522f1ab969', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/home', '2024-08-07 11:23:04', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('b204b5670db04fffb1e4ac46f3d2e34c', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/membershipCardList', '2024-08-11 17:16:03', 'http://localhost:8080/help');
INSERT INTO `pv` VALUES ('b350c45e8165423d95b4934d205f8514', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=4', '2024-08-11 17:24:43', 'http://localhost:8080/thread?topicId=4');
INSERT INTO `pv` VALUES ('b85cdb979dfb4d808a52dbf4634aac1c', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/login?jumpUrl=dGhyZWFkP3RvcGljSWQ9MQ', '2024-08-07 11:01:31', 'http://localhost:8080/thread?topicId=1');
INSERT INTO `pv` VALUES ('b99f896d8f1443a6a5b5bc9d31b95377', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/register?jumpUrl=aW5kZXg', '2024-08-07 10:56:40', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('baddedd3ab3d4d75b7da03a4bf258dcb', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:19:51', 'http://localhost:8080/register?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('bb7c989aaeaa4a1bb90d8152dd24d1c6', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-07 10:58:20', 'http://localhost:8080/user/addQuestion');
INSERT INTO `pv` VALUES ('bd9c343824524633b22b192b94af1113', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/addQuestion', '2024-08-07 10:58:32', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('bf3187bd77d843fbbcd215ff554bc0ca', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/help', '2024-08-11 17:16:06', 'http://localhost:8080/user/control/home');
INSERT INTO `pv` VALUES ('bff9f3cdf87740dd94aed53a98190359', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:20:09', 'http://localhost:8080/membershipCardList');
INSERT INTO `pv` VALUES ('c0d7e0690f1f4e13a082c022dcfc9670', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:30:35', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('c1074de09861488b8665a9e84525bfb4', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/login?jumpUrl=aW5kZXg', '2024-08-11 17:23:02', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('c20f3b1503fe41e9be8d7dfdeedcc157', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:21:22', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('c5168debfedb4d36b3e8b0bb3f4c6987', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/membershipCardList', '2024-08-07 11:22:40', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('c7d9a003ec8149e8b9e9e5832026785c', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-07 11:22:42', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('c82b2d4819e14b2d8f23da8948f4c087', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/askList', '2024-08-11 17:06:52', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('c8606244e66048eda29cda7fe1fd4849', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:14:42', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('ca8f136186ac4d4285015f64b7d38dd9', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', NULL, '2024-08-07 10:01:58', 'http://localhost:8080/sm/e582157475fc7314fac04d0665132cf63fa5ac3025c8d2be36a36cd7641c25b2.map');
INSERT INTO `pv` VALUES ('caffbd99c1d344bd96e187bdec4bcc14', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=1', '2024-08-07 11:01:39', 'http://localhost:8080/thread?topicId=1');
INSERT INTO `pv` VALUES ('ce2f5dfb7f174e44a8324e5262ef342f', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:30:35', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('d07207efb7824cc1b35ea71e3d78fa29', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-07 11:23:05', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('d65f9a874b92426da180d193902e2fd0', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:24:43', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('d6844a706f9f4e88a4899058176398fa', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/home', '2024-08-11 17:16:16', 'http://localhost:8080/user/control/topicList');
INSERT INTO `pv` VALUES ('d89ffe5a9c704dc0ab4c7dba987fdb7e', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:20:29', 'http://localhost:8080/login?jumpUrl=aW5kZXg');
INSERT INTO `pv` VALUES ('dc96eb9c41ce482f916106ef9a414189', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/thread?topicId=4', '2024-08-11 17:25:44', 'http://localhost:8080/thread?topicId=4');
INSERT INTO `pv` VALUES ('dfd4de58cb844564a16da83695100872', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:28:09', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('e08dd81c91a0404bb0329afb6fcb34f9', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/userDynamicList', '2024-08-11 17:24:29', 'http://localhost:8080/thread?topicId=4');
INSERT INTO `pv` VALUES ('e1dd741a1be6480a95e8604f516946aa', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/register', '2024-08-11 17:13:26', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('e21ed48c902a4f7ba4e84176fa0de704', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/?tagId=46072076566156', '2024-08-11 17:16:00', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('e691f4b88f1c4cde97027003a5d8262f', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:25:15', 'http://localhost:8080/user/control/home?userName=gMLDMPa0UGxAbMQM9NM');
INSERT INTO `pv` VALUES ('e8567bac55114414b75d6ad6f60884be', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:21:53', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('ec3d3c888b3a436fa303d6fb524202ae', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/home', '2024-08-07 10:58:12', 'http://localhost:8080/user/control/userDynamicList');
INSERT INTO `pv` VALUES ('f22e2b0cc8f2446c818ac9d4c8ebe280', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/login?jumpUrl=aW5kZXg', '2024-08-11 17:20:38', 'http://localhost:8080/index');
INSERT INTO `pv` VALUES ('f271c37fa290418d94f724b09bf4ddb1', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/home?userName=gMLDMPa0UGxAbMQM9NM', '2024-08-11 17:25:32', 'http://localhost:8080/thread?topicId=4');
INSERT INTO `pv` VALUES ('f476554d40884ab39795f4663982a634', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:24:23', 'http://localhost:8080/user/control/home?userName=gMLDMPa0UGxAbMQM9NM');
INSERT INTO `pv` VALUES ('f488a1496fd445989f9460b99c69d53a', 'Chrome 12 122.0.6261.95', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-07 11:21:53', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('f4de38de84c14b578209a5acebe3094c', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:18:16', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('f57b12f355fc42f3be020692c14e5ccf', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/index', '2024-08-11 17:06:47', 'http://localhost:8080/askList');
INSERT INTO `pv` VALUES ('f5f6da9c48904c6b92cf848a9ece888e', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/user/control/topicList', '2024-08-11 17:16:17', 'http://localhost:8080/user/editTopic?topicId=3');
INSERT INTO `pv` VALUES ('fc091ccd933245c38b4d80b6b39fb9f1', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:44:42', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('fea12e8f5e594ed0826987a6e81c135e', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:49:12', 'http://localhost:8080/');
INSERT INTO `pv` VALUES ('fea14ce6c4244b92bc23fd2dda938ce6', 'Chrome 12 127.0.0.0', '电脑', '0:0:0:0:0:0:0:1', 'WINDOWS_10', 'http://localhost:8080/', '2024-08-11 16:49:06', 'http://localhost:8080/');
...
CREATE TABLE `question`  (
  ...
  `answerTotal` bigint(0) NULL DEFAULT NULL,
  `appendContent` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `isStaff` bit(1) NULL DEFAULT NULL,
  `lastAnswerTime` datetime(0) NULL DEFAULT NULL,
  `lastUpdateTime` datetime(0) NULL DEFAULT NULL,
  `postTime` datetime(0) NULL DEFAULT NULL,
  `sort` int(0) NULL DEFAULT NULL,
  `status` int(0) NULL DEFAULT NULL,
  ...
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `viewTotal` bigint(0) NULL DEFAULT NULL,
  `adoptionAnswerId` bigint(0) NULL DEFAULT NULL,
  `amount` decimal(12, 2) NOT NULL,
  `point` bigint(0) NULL DEFAULT NULL,
  `isMarkdown` bit(1) NULL DEFAULT NULL,
  `markdownContent` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `question_1_idx`(`userName`, `postTime`) USING BTREE,
  INDEX `question_4_idx`(`status`, `sort`, `lastAnswerTime`) USING BTREE,
  INDEX `question_5_idx`(`adoptionAnswerId`, `status`, `sort`, `lastAnswerTime`) USING BTREE,
  INDEX `question_6_idx`(`point`, `status`, `sort`, `lastAnswerTime`) USING BTREE,
  INDEX `question_7_idx`(`amount`, `status`, `sort`, `lastAnswerTime`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `questionfavorite_0`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `questionFavorite_1_idx`(`questionId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `questionindex`  (
  ...
  `indexState` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `questionlike_0`  (
  ...
  `likeId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `question_1_idx`(`questionId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `questionlike_1`  (
  ...
  `likeId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `questionLike_1_idx`(`questionId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `questionrewardplatformshare`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `adoptionTime` datetime(0) NULL DEFAULT NULL,
  ...
  `platformShareProportion` int(0) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `questionRewardPlatformShare_1_idx`(`adoptionTime`) USING BTREE,
  INDEX `questionRewardPlatformShare_2_idx`(`questionId`, `answerUserName`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `questiontag`  (
  ...
  `image` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `questionTag_1_idx`(`sort`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `questiontagassociation`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `questionId` bigint(0) NULL DEFAULT NULL,
  `questionTagId` bigint(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `questionTagAssociation_1_idx`(`questionId`) USING BTREE,
  INDEX `questionTagAssociation_2_idx`(`questionTagId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `receiveredenvelope_0`  (
  ...
  `giveUserId` bigint(0) NULL DEFAULT NULL,
  `receiveTime` datetime(0) NULL DEFAULT NULL,
  `receiveUserId` bigint(0) NULL DEFAULT NULL,
  `version` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `receiveRedEnvelope_1_idx`(`receiveUserId`, `receiveTime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `remind_0`  (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `friendTopicCommentId` bigint(0) NULL DEFAULT NULL,
  `friendTopicReplyId` bigint(0) NULL DEFAULT NULL,
  `readTimeFormat` bigint(0) NULL DEFAULT NULL,
  `receiverUserId` bigint(0) NULL DEFAULT NULL,
  `sendTimeFormat` bigint(0) NULL DEFAULT NULL,
  `senderUserId` bigint(0) NULL DEFAULT NULL,
  `status` int(0) NULL DEFAULT NULL,
  `topicCommentId` bigint(0) NULL DEFAULT NULL,
  `topicId` bigint(0) NULL DEFAULT NULL,
  `topicReplyId` bigint(0) NULL DEFAULT NULL,
  `typeCode` int(0) NULL DEFAULT NULL,
  `friendQuestionAnswerId` bigint(0) NULL DEFAULT NULL,
  `friendQuestionReplyId` bigint(0) NULL DEFAULT NULL,
  `questionAnswerId` bigint(0) NULL DEFAULT NULL,
  `questionId` bigint(0) NULL DEFAULT NULL,
  `questionReplyId` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `remind_1_idx`(`receiverUserId`, `status`, `sendTimeFormat`) USING BTREE,
  INDEX `remind_2_idx`(`topicId`) USING BTREE,
  INDEX `remind_3_idx`(`receiverUserId`, `typeCode`, `sendTimeFormat`) USING BTREE,
  INDEX `remind_4_idx`(`questionId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- Records of remind_2
-- ----------------------------
INSERT INTO `remind_2` VALUES ('1d9e3cad0b1c4e86b4ba3006d1cb73390002', 4, 1, NULL, 2, 1723368280000, 3, 10, NULL, 4, NULL, 110, NULL, NULL, NULL, -1, NULL);
...
-- Records of remind_3
-- ----------------------------
INSERT INTO `remind_3` VALUES ('8d691bc464db4ac39265850eafe890850003', NULL, NULL, NULL, 3, 1723368188224, 2, 10, NULL, -1, NULL, 80, NULL, NULL, NULL, -1, NULL);
INSERT INTO `remind_3` VALUES ('f90e510e89d147a2bfe4a76f530918390003', 5, NULL, NULL, 3, 1723368339864, 2, 10, NULL, 4, NULL, 10, NULL, NULL, NULL, -1, NULL);
...
CREATE TABLE `reply`  (
  ...
  `isFriendStaff` bit(1) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `reply_1_idx`(`commentId`, `status`) USING BTREE,
  INDEX `reply_2_idx`(`topicId`) USING BTREE,
  INDEX `reply_3_idx`(`userName`, `isStaff`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of reply
-- ----------------------------
INSERT INTO `reply` VALUES (1, 4, '是的', '0:0:0:0:0:0:0:1', b'0', '2024-08-11 17:24:40', 4, 'gMLDMPa0UGxAbMQM9NM', 20, NULL, NULL, ',0,', NULL, b'0');
...
CREATE TABLE `report`  (
  ...
  `postTime` datetime(0) NULL DEFAULT NULL,
  `processCompleteTime` datetime(0) NULL DEFAULT NULL,
  ...
  `version` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `report_1_idx`(`parameterId`, `module`, `status`) USING BTREE,
  INDEX `report_2_idx`(`userName`, `status`) USING BTREE,
  INDEX `report_3_idx`(`parameterId`, `userName`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `reporttype`  (
  ...
  `sort` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `reportType_1_idx`(`sort`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `specification`  (
  ...
  `stockOccupy` bigint(0) NULL DEFAULT NULL,
  `unit` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `specification_1_idx`(`membershipCardId`, `sort`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `staffloginlog_0`  (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `logonTime` datetime(0) NULL DEFAULT NULL,
  `staffId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `staffLoginLog_idx`(`staffId`, `logonTime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `staffloginlog_2` VALUES ('7491a6d78a5c42a099d2302d8994cc0b0242', '0:0:0:0:0:0:0:1', '2024-08-11 17:23:25', '187b49b713dd4edda26ff3bcb03474c7');
INSERT INTO `staffloginlog_2` VALUES ('9a494e14caad44989728035c61f451940242', '0:0:0:0:0:0:0:1', '2024-08-11 17:14:53', '187b49b713dd4edda26ff3bcb03474c7');
INSERT INTO `staffloginlog_2` VALUES ('a834bf2e806c427d8615b1f5249e5a740242', '0:0:0:0:0:0:0:1', '2024-08-11 17:18:27', '187b49b713dd4edda26ff3bcb03474c7');
INSERT INTO `staffloginlog_2` VALUES ('d4486da5f7ee4769a5caeb4190e629790242', '0:0:0:0:0:0:0:1', '2024-08-07 10:54:55', '187b49b713dd4edda26ff3bcb03474c7');
INSERT INTO `staffloginlog_2` VALUES ('e5722a73e50e49ffae37643d5c534ae90242', '0:0:0:0:0:0:0:1', '2024-08-07 10:02:09', '187b49b713dd4edda26ff3bcb03474c7');
INSERT INTO `staffloginlog_2` VALUES ('eb63b2919de54086be274a60508db7b30242', '0:0:0:0:0:0:0:1', '2024-08-07 10:59:21', '187b49b713dd4edda26ff3bcb03474c7');
...
CREATE TABLE `subscriptionsystemnotify_0`  (
  ...
  `status` int(0) NULL DEFAULT NULL,
  `systemNotifyId` bigint(0) NULL DEFAULT NULL,
  `userId` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `subscriptionSystemNotify_1_idx`(`systemNotifyId`) USING BTREE,
  INDEX `subscriptionSystemNotify_2_idx`(`userId`, `status`, `systemNotifyId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sysresources`  (
  ...
  `urlType` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `systemnotify`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `systemNotify_1_idx`(`sendTime`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `systemsetting`  (
  `id` int(0) NOT NULL,
  `backstagePageNumber` int(0) NULL DEFAULT NULL,
  `closeSite` int(0) NULL DEFAULT NULL,
  ...
  `forestagePageNumber` int(0) NULL DEFAULT NULL,
  `keywords` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `login_submitQuantity` int(0) NULL DEFAULT NULL,
  `registerCaptcha` bit(1) NOT NULL,
  `supportAccessDevice` int(0) NULL DEFAULT NULL,
  `temporaryFileValidPeriod` int(0) NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userSentSmsCount` int(0) NULL DEFAULT NULL,
  `version` bigint(0) NULL DEFAULT NULL,
  `comment_submitQuantity` int(0) NULL DEFAULT NULL,
  `topic_submitQuantity` int(0) NULL DEFAULT NULL,
  `realNameUserAllowComment` bit(1) NOT NULL,
  `realNameUserAllowTopic` bit(1) NOT NULL,
  `comment_rewardPoint` bigint(0) NULL DEFAULT NULL,
  `reply_rewardPoint` bigint(0) NULL DEFAULT NULL,
  `topic_rewardPoint` bigint(0) NULL DEFAULT NULL,
  ...
  `privateMessage_submitQuantity` int(0) NULL DEFAULT NULL,
  `topicEditorTag` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `comment_review` int(0) NULL DEFAULT NULL,
  `reply_review` int(0) NULL DEFAULT NULL,
  `topic_review` int(0) NULL DEFAULT NULL,
  `topicUnhidePlatformShareProportion` int(0) NULL DEFAULT NULL,
  `fileSecureLinkExpire` bigint(0) NULL DEFAULT NULL,
  ...
  `answerReply_review` int(0) NULL DEFAULT NULL,
  `answerReply_rewardPoint` bigint(0) NULL DEFAULT NULL,
  `answer_review` int(0) NULL DEFAULT NULL,
  `answer_rewardPoint` bigint(0) NULL DEFAULT NULL,
  `answer_submitQuantity` int(0) NULL DEFAULT NULL,
  `questionEditorTag` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `question_review` int(0) NULL DEFAULT NULL,
  `question_rewardPoint` bigint(0) NULL DEFAULT NULL,
  `question_submitQuantity` int(0) NULL DEFAULT NULL,
  `realNameUserAllowAnswer` bit(1) NOT NULL,
  `realNameUserAllowQuestion` bit(1) NOT NULL,
  `maxQuestionTagQuantity` int(0) NULL DEFAULT NULL,
  `questionRewardPlatformShareProportion` int(0) NULL DEFAULT NULL,
  `questionRewardAmountMax` decimal(12, 2) NULL DEFAULT NULL,
  `questionRewardAmountMin` decimal(12, 2) NOT NULL,
  `questionRewardPointMax` bigint(0) NULL DEFAULT NULL,
  `questionRewardPointMin` bigint(0) NULL DEFAULT NULL,
  `allowRegisterAccount` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  ...
  `report_submitQuantity` int(0) NULL DEFAULT NULL,
  `showIpAddress` bit(1) NOT NULL,
  `reportMaxImageUpload` int(0) NULL DEFAULT NULL,
  `supportEditor` int(0) NULL DEFAULT NULL,
  `topicHeatFactor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `topicHotRecommendedTime` int(0) NULL DEFAULT NULL,
  `allowMentionMaxNumber` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `systemsetting` VALUES (1, 30, 1, '网站暂时关闭', '中国移不动', '{\"fontname\":true,\"fontsize\":true,\"forecolor\":true,\"hilitecolor\":true,\"bold\":true,\"italic\":true,\"underline\":true,\"removeformat\":true,\"link\":true,\"unlink\":true,\"justifyleft\":true,\"justifycenter\":true,\"justifyright\":true,\"insertorderedlist\":true,\"insertunorderedlist\":true,\"code\":true,\"emoticons\":true,\"image\":true,\"imageFormat\":[\"jpg\",\"jpeg\",\"bmp\",\"png\",\"gif\"],\"imageSize\":\"5000\",\"file\":false,\"fileFormat\":[],\"fileSize\":null,\"embedVideo\":false,\"uploadVideo\":false,\"videoFormat\":[],\"videoSize\":null,\"hidePassword\":false,\"hideComment\":false,\"hideGrade\":false,\"hidePoint\":false,\"hideAmount\":false,\"fullscreen\":true,\"mention\":false,\"ai\":false}', 30, '中国移不动', 10, b'1', 1, 120, '中国移不动', 10, 1715155242887, 10, 10, b'0', b'0', 5, 5, 10, b'1', b'1', b'1', b'0', '*', 10, '{\"fontname\":true,\"fontsize\":true,\"forecolor\":true,\"hilitecolor\":true,\"bold\":true,\"italic\":true,\"underline\":true,\"removeformat\":true,\"link\":true,\"unlink\":true,\"justifyleft\":true,\"justifycenter\":true,\"justifyright\":true,\"insertorderedlist\":true,\"insertunorderedlist\":true,\"code\":true,\"emoticons\":true,\"image\":true,\"imageFormat\":[\"jpg\",\"jpeg\",\"bmp\",\"png\",\"gif\"],\"imageSize\":\"5000\",\"file\":true,\"fileFormat\":[\"mp4\",\"avi\",\"mkv\",\"wmv\",\"wav\",\"rm\",\"rmvb\",\"mp3\",\"flac\",\"ape\",\"zip\",\"rar\",\"7z\",\"txt\",\"docx\",\"doc\",\"pptx\",\"ppt\",\"xlsx\",\"xls\"],\"fileSize\":\"5000\",\"embedVideo\":true,\"uploadVideo\":true,\"videoFormat\":[\"mp4\",\"avi\",\"mkv\",\"wmv\",\"rm\",\"rmvb\"],\"videoSize\":\"50000\",\"hidePassword\":true,\"hideComment\":true,\"hideGrade\":true,\"hidePoint\":true,\"hideAmount\":true,\"fullscreen\":true,\"mention\":false,\"ai\":false}', 50, 50, 50, 1, 300, '1234567890123456', b'1', b'1', '{\"fontname\":true,\"fontsize\":true,\"forecolor\":true,\"hilitecolor\":true,\"bold\":true,\"italic\":true,\"underline\":true,\"removeformat\":true,\"link\":true,\"unlink\":true,\"justifyleft\":true,\"justifycenter\":true,\"justifyright\":true,\"insertorderedlist\":true,\"insertunorderedlist\":true,\"code\":true,\"emoticons\":true,\"image\":true,\"imageFormat\":[\"jpg\",\"jpeg\",\"bmp\",\"png\",\"gif\"],\"imageSize\":\"5000\",\"file\":false,\"fileFormat\":[],\"fileSize\":null,\"embedVideo\":false,\"uploadVideo\":false,\"videoFormat\":[],\"videoSize\":null,\"hidePassword\":false,\"hideComment\":false,\"hideGrade\":false,\"hidePoint\":false,\"hideAmount\":false,\"fullscreen\":true,\"mention\":false,\"ai\":false}', 50, 5, 50, 5, 10, '{\"fontname\":true,\"fontsize\":true,\"forecolor\":true,\"hilitecolor\":true,\"bold\":true,\"italic\":true,\"underline\":true,\"removeformat\":true,\"link\":true,\"unlink\":true,\"justifyleft\":true,\"justifycenter\":true,\"justifyright\":true,\"insertorderedlist\":true,\"insertunorderedlist\":true,\"code\":true,\"emoticons\":true,\"image\":true,\"imageFormat\":[\"jpg\",\"jpeg\",\"bmp\",\"png\",\"gif\"],\"imageSize\":\"5000\",\"file\":false,\"fileFormat\":[],\"fileSize\":null,\"embedVideo\":false,\"uploadVideo\":false,\"videoFormat\":[],\"videoSize\":null,\"hidePassword\":false,\"hideComment\":false,\"hideGrade\":false,\"hidePoint\":false,\"hideAmount\":false,\"fullscreen\":true,\"mention\":false,\"ai\":false}', 50, 10, 10, b'0', b'0', 5, 1, NULL, 0.00, NULL, 0, '{\"local\":true,\"mobile\":false,\"weChat\":false}', 200.00, 0.01, b'1', 5, b'1', 3, 10, '评论=20|点赞=10|浏览量=1|重力因子=1.8', NULL, 30);
...
CREATE TABLE `sysusers`  (
  ...
  UNIQUE INDEX `UKi13uxat3wa9pt2glvqr05g7rn`(`userAccount`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sysusers
-- ----------------------------
INSERT INTO `sysusers` VALUES ('187b49b713dd4edda26ff3bcb03474c7', b'1', 'admin', b'1', NULL, '管理员', '$2a$10$l97VSJmkhLOdIDylObfRfevWAvq/S38vtOhZcKxJvVBDBzxKQPkb6', 'admin', 'e19031512f1b433d9e1f96c74c595a18', NULL, NULL);
...
CREATE TABLE `tag`  (
  ...
  `image` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `tag_1_idx`(`sort`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tag
-- ----------------------------
INSERT INTO `tag` VALUES (46072076566156, '生活', 0, '');
INSERT INTO `tag` VALUES (46108906685541, '技术', 0, '');
INSERT INTO `tag` VALUES (46108907285542, '娱乐', 0, '');
INSERT INTO `tag` VALUES (46108907885543, '吃瓜', 0, '');
...
CREATE TABLE `thumbnail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UKi1c51f71y0grwc0d7wyoe5mig`(`specificationGroup`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `timetask`  (
  ...
  `misfireInstruction` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `topic`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `allow` bit(1) NOT NULL,
  `commentTotal` bigint(0) NULL DEFAULT NULL,
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `isStaff` bit(1) NULL DEFAULT NULL,
  `lastReplyTime` datetime(0) NULL DEFAULT NULL,
  `postTime` datetime(0) NULL DEFAULT NULL,
  `tagId` bigint(0) NULL DEFAULT NULL,
  `title` varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `viewTotal` bigint(0) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `topic_idx`(`tagId`, `status`) USING BTREE,
  INDEX `topic_3_idx`(`userName`, `postTime`) USING BTREE,
  INDEX `topic_5_idx`(`status`, `sort`, `lastReplyTime`) USING BTREE,
  INDEX `topic_6_idx`(`weight`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of topic
-- ----------------------------
INSERT INTO `topic` VALUES (1, b'1', 1, 'LOL CF DNF', '0:0:0:0:0:0:0:1', b'1', '2024-08-07 11:01:36', '2024-08-07 11:01:00', 46072076566156, '生活像一把无尽刻刀', 'admin', 1, NULL, 20, 'LOL CF DNF..', 0, NULL, NULL, b'0', b'0', NULL, 0);
INSERT INTO `topic` VALUES (2, b'1', 0, '王侯将相 宁有种乎?', '0:0:0:0:0:0:0:1', b'0', '2024-08-07 11:22:22', '2024-08-07 11:22:22', 46072076566156, '陈胜', 'S30haD6EltuuM6z7CD4', 0, NULL, 20, '王侯将相 宁有种乎?..', 0, NULL, NULL, b'0', b'0', NULL, 0);
INSERT INTO `topic` VALUES (3, b'1', 0, '2121421', '0:0:0:0:0:0:0:1', b'0', '2024-08-11 17:14:38', '2024-08-11 17:14:38', 46072076566156, '为什么爸爸爱妈妈', 'VUWuDd534ygxgEaaVJv', 0, NULL, 20, '2121421..', 0, NULL, NULL, b'0', b'0', NULL, 0);
INSERT INTO `topic` VALUES (4, b'1', 4, '因为他们会唱跳ra\'p', '0:0:0:0:0:0:0:1', b'0', '2024-08-11 17:25:40', '2024-08-11 17:22:52', 46108907885543, '为什么娱乐圈的人门槛这么低', 'gMLDMPa0UGxAbMQM9NM', 1, NULL, 20, '因为他们会唱跳ra\'p..', 0, NULL, NULL, b'0', b'0', NULL, 0);
...
CREATE TABLE `topicfavorite_0`  (
  ...
  `favoriteId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `topicFavorite_1_idx`(`topicId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `topiclike_0`  (
  ...
  `likeId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `topicLike_1_idx`(`topicId`, `addtime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `topicunhide_0`  (
  ...
  `hideTagType` int(0) NULL DEFAULT NULL,
  `point` bigint(0) NULL DEFAULT NULL,
  `postUserName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `topicId` bigint(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `topicUnhide_1_idx`(`topicId`, `cancelTime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `topicunhideplatformshare`  (
  ...
  `topicId` bigint(0) NULL DEFAULT NULL,
  `totalAmount` decimal(12, 2) NOT NULL,
  `unlockTime` datetime(0) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `topicUnhidePlatformShare_1_idx`(`unlockTime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `upgradesystem`  (
  ...
  `updatePackageTime` datetime(0) NULL DEFAULT NULL,
  ...
  `upgradeTime` datetime(0) NULL DEFAULT NULL,
  `version` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `user`  (
  ...
  `state` int(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userVersion` int(0) NULL DEFAULT NULL,
  `securityDigest` bigint(0) NULL DEFAULT NULL,
  `avatarName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `nickname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `cancelAccountTime` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UKmtrfpdps3j0ce18c8xglgjf7n`(`platformUserId`) USING BTREE,
  UNIQUE INDEX `UKdnq7r8jcmlft7l8l4j79l1h74`(`account`) USING BTREE,
  INDEX `user_idx`(`state`) USING BTREE,
  INDEX `user_2_idx`(`userName`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '76c57f9d73b8fa17cce8febf319f1b54d3e0158168de359432099c652e9f4c6c', NULL, '你是？', NULL, 'c2508d5023f0b0881f20bb1a7e2d8a1bdd51290a86f44c679ff0659c22b6a9de', 15, b'0', '2024-08-07 10:56:40', NULL, 'fe109af821fe434db94e0fd5e12902e6', 1, 'S30haD6EltuuM6z7CD4', 2, 1722999399611, NULL, NULL, b'1', 0.0000, 'S30haD6EltuuM6z7CD4', 10, '9527', -1);
INSERT INTO `user` VALUES (2, 'c7d9164fa9417af7242be2dff528e36ad9e3c81953f5decd0cf6b83066007380', '2421414@qq.com', '你是？', NULL, 'be5886df40c871c29c89c888861c1bc37f9b0df81c69ceea9598b5d4078df230', 15, b'0', '2024-08-11 17:14:25', NULL, '926f09e46ee24c018c45492404f2b163', 1, 'VUWuDd534ygxgEaaVJv', 2, 1723367664650, NULL, NULL, b'1', 0.0000, 'VUWuDd534ygxgEaaVJv', 10, 'china_', -1);
INSERT INTO `user` VALUES (3, 'c7d9164fa9417af7242be2dff528e36ad9e3c81953f5decd0cf6b83066007380', '123123@qq.com', '你是？', NULL, '89b4ef6f000528db081455b80c5a2233aeba049c86d582051be7c5b9725d509a', 15, b'0', '2024-08-11 17:22:23', NULL, '5bfff8996ef84c79a5648b7e504fa63e', 1, 'gMLDMPa0UGxAbMQM9NM', 2, 1723368143288, NULL, NULL, b'1', 0.0000, 'gMLDMPa0UGxAbMQM9NM', 10, 'america', -1);
...
CREATE TABLE `usercustom`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `chooseType` int(0) NULL DEFAULT NULL,
  `cols` int(0) NULL DEFAULT NULL,
  `fieldFilter` int(0) NULL DEFAULT NULL,
  ...
  `selete_size` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `userdynamic_0`  (
  ...
  `topicId` bigint(0) NULL DEFAULT NULL,
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `quoteCommentId` bigint(0) NULL DEFAULT NULL,
  `answerId` bigint(0) NULL DEFAULT NULL,
  `answerReplyId` bigint(0) NULL DEFAULT NULL,
  `questionId` bigint(0) NULL DEFAULT NULL,
  `functionIdGroup` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userDynamic_1_idx`(`userName`, `status`, `postTime`) USING BTREE,
  INDEX `userDynamic_5_idx`(`functionIdGroup`, `userName`, `module`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `userdynamic_1` VALUES ('364e89a708b84434af1efeaf12397d870001', -1, 100, '2024-08-07 11:22:22', -1, 20, 2, 'S30haD6EltuuM6z7CD4', -1, -1, -1, -1, ',2,');
INSERT INTO `userdynamic_1` VALUES ('ea477e2983d74505a574b9d51451478c0001', 1, 200, '2024-08-07 11:01:36', -1, 120, 1, 'S30haD6EltuuM6z7CD4', -1, -1, -1, -1, ',1,1,');
...
-- ----------------------------
INSERT INTO `userdynamic_2` VALUES ('39616aee798f4ce88465922ca69b4a480002', -1, 100, '2024-08-11 17:14:38', -1, 20, 3, 'VUWuDd534ygxgEaaVJv', -1, -1, -1, -1, ',3,');
INSERT INTO `userdynamic_2` VALUES ('79003e98a31946dfb67ad5c539db3f100002', 5, 200, '2024-08-11 17:25:40', -1, 120, 4, 'VUWuDd534ygxgEaaVJv', -1, -1, -1, -1, ',4,5,');
...
-- ----------------------------
INSERT INTO `userdynamic_3` VALUES ('181fbc0bac1d4060a12d1179ed543a620003', 4, 400, '2024-08-11 17:24:40', 1, 20, 4, 'gMLDMPa0UGxAbMQM9NM', -1, -1, -1, -1, ',4,4,1,');
INSERT INTO `userdynamic_3` VALUES ('82b0d4fc53534442a0ff212092ed877f0003', -1, 100, '2024-08-11 17:22:52', -1, 20, 4, 'gMLDMPa0UGxAbMQM9NM', -1, -1, -1, -1, ',4,');
...
CREATE TABLE `usergrade`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `needPoint` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `userinputvalue`  (
  ...
  `userCustomId` int(0) NULL DEFAULT NULL,
  `userId` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userinputvalue_idx`(`userId`, `options`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `userloginlog_0`  (
  ...
  `logonTime` datetime(0) NULL DEFAULT NULL,
  `userId` bigint(0) NULL DEFAULT NULL,
  `typeNumber` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userLoginLog_idx`(`userId`, `logonTime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `userloginlog_1` VALUES ('09b566cb79f042eda2b2a3950f00ae950001', '0:0:0:0:0:0:0:1', '2024-08-07 10:56:40', 1, 10);
INSERT INTO `userloginlog_1` VALUES ('c98d633c749d40588e8b342d71681f270001', '0:0:0:0:0:0:0:1', '2024-08-07 11:01:31', 1, 10);
...
-- ----------------------------
INSERT INTO `userloginlog_2` VALUES ('83a6acfa5d4649c0afc4c82d820455f60002', '0:0:0:0:0:0:0:1', '2024-08-11 17:20:37', 2, 10);
INSERT INTO `userloginlog_2` VALUES ('8e867988287641ca9ea54ec77ccc746a0002', '0:0:0:0:0:0:0:1', '2024-08-11 17:14:25', 2, 10);
...
-- ----------------------------
INSERT INTO `userloginlog_3` VALUES ('faba1797f42c440e9ffb0d18a243b7eb0003', '0:0:0:0:0:0:0:1', '2024-08-11 17:22:23', 3, 10);
...
CREATE TABLE `userrolegroup`  (
  ...
  `userName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userRoleId` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `validPeriodEnd` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userRoleGroup_1_idx`(`userName`, `validPeriodEnd`) USING BTREE,
  INDEX `userRoleGroup_3_idx`(`userRoleId`, `userName`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
